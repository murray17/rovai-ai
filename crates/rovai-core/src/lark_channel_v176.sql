...
CREATE TABLE channel_credentials_v176 (
...
INSERT INTO channel_credentials_v176 SELECT * FROM channel_credentials;

DROP TABLE channel_credentials;

ALTER TABLE channel_credentials_v176 RENAME TO channel_credentials;
...
CREATE TABLE channel_developer_sessions_v176 (
...
INSERT INTO channel_developer_sessions_v176 SELECT * FROM channel_developer_sessions;

DROP TABLE channel_developer_sessions;

ALTER TABLE channel_developer_sessions_v176 RENAME TO channel_developer_sessions;

CREATE TABLE automation_notification_delivery_v176 (
...
INSERT INTO automation_notification_delivery_v176 SELECT * FROM automation_notification_delivery;

DROP TABLE automation_notification_delivery;

ALTER TABLE automation_notification_delivery_v176 RENAME TO automation_notification_delivery;
