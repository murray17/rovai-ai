...
CREATE TABLE channel_credentials_v173 (
...
INSERT INTO channel_credentials_v173 SELECT * FROM channel_credentials;

DROP TABLE channel_credentials;

ALTER TABLE channel_credentials_v173 RENAME TO channel_credentials;
...
CREATE TABLE channel_developer_sessions_v173 (
...
INSERT INTO channel_developer_sessions_v173 SELECT * FROM channel_developer_sessions;

DROP TABLE channel_developer_sessions;

ALTER TABLE channel_developer_sessions_v173 RENAME TO channel_developer_sessions;

CREATE TABLE automation_notification_delivery_v173 (
...
INSERT INTO automation_notification_delivery_v173 SELECT * FROM automation_notification_delivery;

DROP TABLE automation_notification_delivery;

ALTER TABLE automation_notification_delivery_v173 RENAME TO automation_notification_delivery;
...
DELETE FROM schema_migration WHERE version=174;
UPDATE rovai_data_contract SET contract_version='v1.69', projection_schema_version=123 WHERE singleton=1;
