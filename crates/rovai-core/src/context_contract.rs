...
pub const AGENT_RUN_CONTEXT_FORMATTER_VERSION: i64 = 8;
...
mod tests {
    ...
    fn shared_fixture() -> Value {
        serde_json::from_str(include_str!(
            "../../../packages/contracts/fixtures/agent-run-context-v8.json"
        ))
    ...
    fn binding_contract_freezes_each_context_axis_version() {
        ...
        assert_eq!(fixture["contextManifestFormatterVersion"], 8);
