...
pub const BOOTSTRAP_REDELIVERY_ENVELOPE_VERSION: i64 = 1;
pub const BOOTSTRAP_REDELIVERY_FORMATTER_VERSION: i64 = 1;
...
pub const fn release_default_policy(adapter_kind: AdapterKind) -> CompactionDetectorPolicy {
    match adapter_kind {
        ...
        AdapterKind::AntigravityApp | AdapterKind::CodexCli | AdapterKind::ClaudeCodeCli => {
            CompactionDetectorPolicy::Disabled
        }
    }
}
