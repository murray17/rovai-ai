...
[Built-in Tool Transport v14](../contracts/builtin-tool-transport-v14.md) uses one discriminated endpoint. Windows Pipe
...
The macOS Unix Socket implementation also moves to v14. Router, operation catalog, receipt, replay and Agent Output are
unchanged and remain transport-independent.
