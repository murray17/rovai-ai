...
| [飞书渠道](feishu-channel.md) | Developer Session/队员 Provisioner、owner-only ProjectBinding、ExternalPrincipal、多 Bot 聚合、统一 Camp admission、群 roster、Main secret 与 Core Outbox 边界 |
