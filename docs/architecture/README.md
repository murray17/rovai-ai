...
| [Built-in Tool Runtime](builtin-tool-runtime.md) | Agent CLI v10、Core Router、Runtime Fleet、精确 help、Scope-identified Memory、Core-resolved inline alias、十二项 official Skill 与 Runtime 对齐协作消息、peer routing Dynamic Context、ContextManifest/ACK 与外部 MCP 的关系 |
...
| [Public A2A Message 与 Message Delivery](public-a2a-message-delivery.md) | 公共 Structured Message、canonical/display-name inline addressing、正交 Current User Attention、forward/caller-return Delivery、原子通知、Context gate 与 UI projection 边界 |
