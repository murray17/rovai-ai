...
| [飞书渠道](feishu-channel.md) | Developer Session/队员 Provisioner、Owner-only 入站、Quick Chat/Project Catalog、PendingCampBinding、ExternalPrincipal、多 Bot 聚合、统一 Camp admission、群 roster、Main secret 与 Core Outbox 边界 |
