...
| [File Preview](file-preview.md) | 显式 Markdown 消息资源入口、共享资源视觉类型、Core 领域来源、Main classifier、窗口内 Camp Tab shell、项目内子文件独立恢复来源、无副作用恢复、binding generation、具体文件能力/重开、分页、Root Grant、watcher、HTML 协议与资源生命周期 |
