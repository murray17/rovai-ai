...
| [钉钉渠道](dingtalk-channel.md) | Rovai OAuth/DWS Gateway、独立队员应用机器人、Owner-only 私聊/群聊、provider-neutral admission、群 roster、AI 卡片/Markdown、feature gate 与 Main secret/Core Outbox 边界 |
