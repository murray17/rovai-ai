...
该 alias teaching/schema 继续进入当前 catalog digest。v10 的 contract/CLI command version 与 Runtime
capability 变化来自 Memory closed wire shape；Binding compatibility 继续同时校验 version 与 digest。
