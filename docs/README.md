...
| 修改 Camp 文件/目录附件、Composer 拖放、快照限制、Agent read 附件摘要或 Runtime 附件路径 | [Camp Attachment v1](contracts/camp-attachment-v1.md)、[Camp History Retrieval v2](contracts/camp-history-v2.md)、[ADR-0169](adr/0169-core-owned-directory-attachment-snapshots.md)及[会话区拖放 UI](ui/components/conversation-drop-zone.md) |
...
| 修改 Composer Skill Picker 的结构化身份、发送时资格、`CURRENT_INPUT.skills` 文件链接或对应 Manifest Evidence | 先按[核心模型上下文变更治理](development/model-context-change-governance.md)确认 revision，再读[ADR-0203](adr/0203-structured-current-input-skill-links.md)、[Current Input Skill Links v1](contracts/current-input-skill-links-v1.md)、[ContextManifest Evidence v17](contracts/context-manifest-evidence-v17.md)、[Structured Current Input Skill Links 架构](architecture/structured-current-input-skill-links.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
