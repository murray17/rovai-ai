...
| 修改飞书或钉钉渠道、队员 Bot、Owner identity、OAuth/Developer Session、Quick Chat/Project Catalog、PendingCampBinding、渠道会话、ExternalPrincipal、多 Bot、ChannelTurnRequest、群 roster、执行控制台、永久输出/附件、卡片/Outbox 或渠道设置 UI | 先按 Provider 读取 [Feishu Channel v2](contracts/feishu-channel-v2.md)与[飞书渠道架构](architecture/feishu-channel.md)，或 [DingTalk Channel v1](contracts/dingtalk-channel-v1.md)与[钉钉渠道架构](architecture/dingtalk-channel.md)；共享边界继续读[Camp Membership v1](contracts/camp-membership-v1.md)、[Camp Attachment v6](contracts/camp-attachment-v6.md)、[ContextManifest Evidence v22](contracts/context-manifest-evidence-v22.md)及[渠道设置](ui/components/channel-settings.md) |
