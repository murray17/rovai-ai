...
| 修改 Runtime-reported Command Diff、Canonical Activity `diffProjection`、Workspace Change Window、Git checkpoint/synthetic tree、Window Coordinator 或对应授权读取 | [Workspace Change Observation v1](contracts/workspace-change-observation-v1.md)、[Workspace Change Observation 架构](architecture/workspace-change-observation.md)、[Workspace/Git 不变量](architecture/foundational-invariants.md#camp-workspace)、[Evidence/Activity 不变量](architecture/foundational-invariants.md#evidence-canonical-activity)及[v1.29 实施计划](versions/v1.29/implementation-plan.md)；具体 UI 另行确认 |
