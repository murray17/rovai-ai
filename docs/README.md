...
| 修改 Camp 文件预览、窗口内 Tab 恢复、owner-scoped 附件打开、消息文件打开、具体文件能力、预览句柄/分页/Root Grant、HTML 沙箱、root watcher、文件 Tabs 或刷新 | [File Preview v7](contracts/file-preview-v7.md)、[File Preview Architecture](architecture/file-preview.md)、[Camp 文件预览区](ui/components/file-preview.md)、[Camp 会话工作区](ui/components/conversation-workspace.md)、[v1.51 当前范围](versions/v1.51/README.md)及[v1.30 初始实施](versions/v1.30/implementation-plan.md) |
