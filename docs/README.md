...
| 修改内置 Agent CLI、IPC、Envelope、receipt、Projection 或幂等合同 | [Built-in Tool Transport v10 合同](contracts/builtin-tool-transport-v10.md)、[Camp Message Send v6](contracts/camp-message-send-v6.md)及[Current User Attention v3](contracts/current-user-attention-v3.md) |
