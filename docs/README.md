...
| 修改 Camp 文件预览、消息文件引用、预览句柄/分页/Root Grant、HTML 沙箱、root watcher、文件 Tabs、刷新或选区附加 | [File Preview v1](contracts/file-preview-v1.md)、[File Preview Architecture](architecture/file-preview.md)、[Camp 文件预览区](ui/components/file-preview.md)、[Camp 会话工作区](ui/components/conversation-workspace.md)及[v1.30 实施计划](versions/v1.30/implementation-plan.md) |
