...
| 修改用户消息回复、接收者延续、Composer Text + Atom/Typeahead/Clipboard、Draft 同步、离开 Camp 导航、App 退出前保存、纯附件/排队附件发送、失效换人或 Draft-only user send | [Composer Draft 不变量](architecture/foundational-invariants.md#camp-composer)、[Camp Composer Draft v11](contracts/camp-composer-draft-v11.md)、[Pending Camp Input v3](contracts/pending-camp-input-v3.md)、[Camp Composer Draft 架构](architecture/camp-composer-draft.md)、[结构化 Mention 与 Atom](ui/components/structured-mentions.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
