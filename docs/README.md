...
| 修改 Camp 内单聊、私有 Conversation、Single Chat Context/Built-in policy、私有 terminal 路由、结束/取消、Conversation 级待发送队列或单聊 UI | [Single Chat v3](contracts/single-chat-v3.md)、[Single Chat Architecture](architecture/single-chat.md)、[Camp Attachment v8](contracts/camp-attachment-v8.md)、[Camp 会话工作区](ui/components/conversation-workspace.md#camp-内单聊) |
...
| 修改内置 Agent CLI、IPC、Envelope、receipt、Projection、Gather、Single Chat history、定时 Automation、队员创建、纯附件 Agent Send 或幂等合同 | [Built-in Tool Transport v23 合同](contracts/builtin-tool-transport-v23.md)、[Built-in 运输不变量](architecture/foundational-invariants.md#skills-builtin-transport)、[Gather v5](contracts/gather-v5.md)、[Skill Library 与投影不变量](architecture/foundational-invariants.md#skills-library-projection)、[Camp Message Send v19](contracts/camp-message-send-v19.md)及[Current User Attention v5](contracts/current-user-attention-v5.md) |
| 修改普通用户 `rovai app`、Workspace inspection、Camp/Run 终端自动化、Diagnostic Trial、双 cursor 或诊断 bundle | [User Automation v2](contracts/user-automation-v2.md)、[User Automation Architecture](architecture/user-automation.md)、[Workspace 与动态 Git 不变量](architecture/foundational-invariants.md#camp-workspace)及[当前版本](versions/v1.54/README.md) |
...
| 修改 AgentRun 局部停止入口、直接提交、权威停止状态，实际模型观测、命令/搜索详情、Tool 聚合、Runtime Compaction 本地展示、运行中 Runtime diagnostic、首值冻结、默认策略回退、执行台位置偏好、进入恢复或模型展示 | [Runtime Catalog 与 Installation 不变量](architecture/foundational-invariants.md#runtime-catalog-installation)、[产品/执行表面不变量](architecture/foundational-invariants.md#product-execution-surface)、[Runtime Catalog Boundaries](architecture/runtime-catalog-boundaries.md)、[Run Process Detail Surface v31](contracts/run-process-detail-surface-v31.md)、[Camp Open Projection v17](contracts/camp-open-projection-v17.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
| 修改 Runtime-reported 文件操作、阅读操作、Command Diff、AgentRun 文件变化卡片、managed output 排除、归约/读取授权或文件变化呈现 | [Runtime File Change Observation v3](contracts/runtime-file-change-observation-v3.md)、[Runtime File Change Observation 架构](architecture/runtime-file-change-observation.md)、[Evidence/Activity 不变量](architecture/foundational-invariants.md#evidence-canonical-activity)、[Camp 会话工作区](ui/components/conversation-workspace.md)及[v1.53 实施计划](versions/v1.53/implementation-plan.md) |
| 修改 Camp 文件预览、执行过程文件入口、窗口内 Tab 恢复、项目内子文件独立恢复、owner-scoped 附件打开、消息文件打开、具体文件能力、预览句柄/分页/Root Grant、HTML 沙箱、root watcher、文件 Tabs 或刷新 | [File Preview v8](contracts/file-preview-v8.md)、[File Preview Architecture](architecture/file-preview.md)、[Camp 文件预览区](ui/components/file-preview.md)、[Camp 会话工作区](ui/components/conversation-workspace.md)、[v1.53 交付范围](versions/v1.53/README.md)及[v1.30 初始实施](versions/v1.30/implementation-plan.md) |
