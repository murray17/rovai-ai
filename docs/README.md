...
| 修改 Runtime-reported 文件操作、阅读操作、Command Diff、AgentRun 文件变化卡片、managed output 排除、归约/读取授权或文件变化呈现 | [Runtime File Change Observation v4](contracts/runtime-file-change-observation-v4.md)、[Runtime File Change Observation 架构](architecture/runtime-file-change-observation.md)、[Evidence/Activity 不变量](architecture/foundational-invariants.md#evidence-canonical-activity)、[Camp 会话工作区](ui/components/conversation-workspace.md)及[v1.55 实施计划](versions/v1.55/implementation-plan.md) |
| 修改 Camp 文件预览、Files Changed 预览路由、执行过程文件入口、消息文件链接、路径呈现或解析基准、窗口内 Tab 恢复、项目内子文件独立恢复、owner-scoped 附件打开、具体文件能力、预览句柄/分页/Root Grant、HTML 沙箱、root watcher、文件 Tabs 或刷新 | [File Preview v10](contracts/file-preview-v10.md)、[File Preview Architecture](architecture/file-preview.md)、[Camp 文件预览区](ui/components/file-preview.md)、[Camp 会话工作区](ui/components/conversation-workspace.md)、[v1.55 交付范围](versions/v1.55/README.md)及[v1.30 初始实施](versions/v1.30/implementation-plan.md) |
