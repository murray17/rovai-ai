...
| 修改内置 Agent CLI、IPC、Envelope、receipt、Projection 或幂等合同 | [Built-in Tool Transport v6 合同](contracts/builtin-tool-transport-v6.md)及[Camp Message Send v3](contracts/camp-message-send-v3.md) |
