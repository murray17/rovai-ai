...
| 修改内置 Agent CLI、IPC、Envelope、receipt、Projection、Gather、队员创建或幂等合同 | [Built-in Tool Transport v14 合同](contracts/builtin-tool-transport-v14.md)、[Built-in Tool Agent Output Projection v1](contracts/builtin-tool-agent-output-projection-v1.md)、[ADR-0212](adr/0212-cross-platform-local-ipc-transport-v14.md)、[Gather v2](contracts/gather-v2.md)、[ADR-0191](adr/0191-agent-mediated-member-creation-and-thirteen-skill-inventory.md)、[Camp Message Send v9](contracts/camp-message-send-v9.md)及[Current User Attention v4](contracts/current-user-attention-v4.md) |
| 修改 `camp.search`、`camp.read`、`history.search`、跨 Camp Manifest/live authorization、Public A2A 历史可见性、Camp message publication fence 或 Agent read 附件输出 | [Camp History Retrieval v1](contracts/camp-history-v1.md)、[ADR-0215](adr/0215-unified-single-camp-history-target-and-publication-boundary.md)、[ADR-0106](adr/0106-agent-bounded-cross-camp-public-history-retrieval.md)、[ADR-0108](adr/0108-discovery-only-camp-message-search-and-sequence-paged-reads.md)、[ADR-0130](adr/0130-public-a2a-message-and-unified-delivery.md)、[Built-in Tool Runtime](architecture/builtin-tool-runtime.md)及[Public A2A Message Delivery](architecture/public-a2a-message-delivery.md) |
...
| 修改 Camp 文件/目录附件、Composer 拖放、快照限制、Agent read 附件摘要或 Runtime 附件路径 | [Camp Attachment v1](contracts/camp-attachment-v1.md)、[Camp History Retrieval v1](contracts/camp-history-v1.md)、[ADR-0169](adr/0169-core-owned-directory-attachment-snapshots.md)及[会话区拖放 UI](ui/components/conversation-drop-zone.md) |
...
| 修改 Composer Skill Picker 的结构化身份、发送时资格、`CURRENT_INPUT.skills` 文件链接或对应 Manifest Evidence | 先按[核心模型上下文变更治理](development/model-context-change-governance.md)确认 revision，再读[ADR-0203](adr/0203-structured-current-input-skill-links.md)、[Current Input Skill Links v1](contracts/current-input-skill-links-v1.md)、[ContextManifest Evidence v16](contracts/context-manifest-evidence-v16.md)、[Structured Current Input Skill Links 架构](architecture/structured-current-input-skill-links.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
