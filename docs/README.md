...
| 修改 Camp 内单聊、私有 Conversation、Single Chat Context/Built-in policy、私有 terminal 路由、结束/取消或单聊 UI | [Single Chat v1](contracts/single-chat-v1.md)、[Single Chat Architecture](architecture/single-chat.md)、[Camp 会话工作区](ui/components/conversation-workspace.md#camp-内单聊) |
...
| 修改 Camp 文件预览、消息文件打开、具体文件能力、预览句柄/分页/Root Grant、HTML 沙箱、root watcher、文件 Tabs 或刷新 | [File Preview v4](contracts/file-preview-v4.md)、[File Preview Architecture](architecture/file-preview.md)、[Camp 文件预览区](ui/components/file-preview.md)、[Camp 会话工作区](ui/components/conversation-workspace.md)、[v1.39 当前范围](versions/v1.39/README.md)及[v1.30 初始实施](versions/v1.30/implementation-plan.md) |
