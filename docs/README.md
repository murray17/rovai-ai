...
| 修改内置 Agent CLI、IPC、Envelope、receipt、Projection、Gather、队员创建、纯附件 Agent Send 或幂等合同 | [Built-in Tool Transport v21 合同](contracts/builtin-tool-transport-v21.md)、[Built-in 运输不变量](architecture/foundational-invariants.md#skills-builtin-transport)、[Gather v4](contracts/gather-v4.md)、[Skill Library 与投影不变量](architecture/foundational-invariants.md#skills-library-projection)、[Camp Message Send v15](contracts/camp-message-send-v15.md)及[Current User Attention v4](contracts/current-user-attention-v4.md) |
...
| 修改 Desktop 启动壳层、Full Core Supervisor、data-dir lease、SQLite authority 准入/迁移、generation fencing、bootstrap diagnostics 或 Core request failure transport | [Desktop 可用性与权威准入不变量](architecture/foundational-invariants.md#desktop-authority-admission)、[Availability-first Runtime](architecture/availability-first-runtime.md)、[Desktop Runtime Availability v1](contracts/desktop-runtime-availability-v1.md)及[Bootstrap Shell](ui/components/bootstrap-shell.md) |
