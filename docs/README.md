...
| 修改 Camp 文件预览、Files Changed 预览路由、执行过程文件入口、窗口内 Tab 恢复、项目内子文件独立恢复、owner-scoped 附件打开、消息文件打开、具体文件能力、预览句柄/分页/Root Grant、HTML 沙箱、root watcher、文件 Tabs 或刷新 | [File Preview v9](contracts/file-preview-v9.md)、[File Preview Architecture](architecture/file-preview.md)、[Camp 文件预览区](ui/components/file-preview.md)、[Camp 会话工作区](ui/components/conversation-workspace.md)、[v1.54 交付范围](versions/v1.54/README.md)及[v1.30 初始实施](versions/v1.30/implementation-plan.md) |
