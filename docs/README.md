...
| 修改上下文 Gate、内置 Skill 回归、每周任务评测、每日 Trace 导出／统计／分析 | [双轨评测流程](development/evaluation.md)、[Execution Evaluation v3](contracts/execution-evaluation-v3.md)、[User Automation v4](contracts/user-automation-v4.md)与[双轨架构](architecture/execution-evaluation.md) |
