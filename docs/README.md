...
| 任务 | 必读资料 |
|---|---|
| 修改 Runtime 结构化图片、混合临时文件生命周期、Run 图片读取、图片附件 Gallery、消息附件分区/几何或本地图片与飞书显式文件交付边界 | [Runtime 图片架构](architecture/runtime-images.md)、[Runtime Images v4](contracts/runtime-images-v4.md)、[Camp Open Projection v15](contracts/camp-open-projection-v15.md)及[统一图片与文件展示](ui/components/conversation-workspace.md#runtime-图片与消息图片) |
| 修改 Camp 成员 Fast、原生订阅资格、三态偏好、绑定代次或单次执行档位 | [Camp Member Fast v1](contracts/camp-member-fast-v1.md)、[Runtime Launch v35](contracts/runtime-launch-and-verification-v35.md)、[Usage v4](contracts/runtime-usage-monitoring-v4.md)、[Camp 会话工作区](ui/components/conversation-workspace.md) |
...
| 修改 Camp 动态添加/移除队员、至少一位成员、Default Lead 替换、membership generation/version、离队 cutover/reconciliation、外部 roster 同步或成员管理 UI | [Camp Membership v2](contracts/camp-membership-v2.md)、[动态 Camp 队员关系](architecture/dynamic-camp-membership.md)、[成员生命周期不变量](architecture/foundational-invariants.md#member-lifecycle)、[协作与执行准入不变量](architecture/foundational-invariants.md#collaboration-admission)、[Camp Open Projection v15](contracts/camp-open-projection-v15.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
| 修改飞书或钉钉渠道、渠道 credential/Developer Session 存储、队员 Bot、Owner identity、OAuth、Quick Chat/Project Catalog、PendingCampBinding、渠道会话、ExternalPrincipal、多 Bot、ChannelTurnRequest、群 roster、执行控制台、永久输出/附件、卡片/Outbox 或渠道设置 UI | 先读 [Channel Storage v3](contracts/channel-storage-v3.md)，再按 Provider 读取 [Feishu Channel v15](contracts/feishu-channel-v15.md)与[飞书渠道架构](architecture/feishu-channel.md)，或 [DingTalk Channel v12](contracts/dingtalk-channel-v12.md)与[钉钉渠道架构](architecture/dingtalk-channel.md)；共享边界继续读[Camp Membership v2](contracts/camp-membership-v2.md)、[Camp Attachment v8](contracts/camp-attachment-v8.md)、[ContextManifest Evidence v22](contracts/context-manifest-evidence-v22.md)及[渠道设置](ui/components/channel-settings.md) |
...
| 修改 Camp 文件预览、owner-scoped 附件打开、消息文件打开、具体文件能力、预览句柄/分页/Root Grant、HTML 沙箱、root watcher、文件 Tabs 或刷新 | [File Preview v6](contracts/file-preview-v6.md)、[File Preview Architecture](architecture/file-preview.md)、[Camp 文件预览区](ui/components/file-preview.md)、[Camp 会话工作区](ui/components/conversation-workspace.md)、[v1.42 当前范围](versions/v1.42/README.md)及[v1.30 初始实施](versions/v1.30/implementation-plan.md) |
