...
| 修改 Camp 内单聊、私有 Conversation、Single Chat Context/Built-in policy、私有 terminal 路由、结束/取消、Conversation 级待发送队列或单聊 UI | [Single Chat v4](contracts/single-chat-v4.md)、[Single Chat Architecture](architecture/single-chat.md)、[Camp Attachment v9](contracts/camp-attachment-v9.md)、[Camp 会话工作区](ui/components/conversation-workspace.md#camp-内单聊) |
