...
| 修改渠道 Host 轮询、维护回执、FIFO 提升或 delivery lease 恢复 | [Channel Host Maintenance v3](contracts/channel-host-maintenance-v3.md)、[Core 事务不变量](architecture/foundational-invariants.md#core-command-transaction)及对应 Provider 当前合同 |
