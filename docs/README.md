...
| 新增 Agent Runtime、建立真实 Probe、判断 Settings Preview 或主机平台准入边界 | [Runtime Catalog Boundaries](architecture/runtime-catalog-boundaries.md)、[Runtime Platform Admission v1](contracts/runtime-platform-admission-v1.md)、[TRAE Runtime 准入版本](versions/v0.83/README.md)、[TRAE Research/Probe](research/trae-cli-runtime/README.md)及相关 Runtime/Activity ADR |
| 修改 Runtime Usage、监控 collection、Coverage、成本层或设置页运行监控 | [ADR-0205](adr/0205-minimal-runtime-usage-metering.md)、[Runtime Monitoring 架构](architecture/runtime-monitoring.md)、[Runtime Usage Monitoring v3](contracts/runtime-usage-monitoring-v3.md)及[可采集性审计](research/runtime-monitoring/README.md) |
| 修改 Runtime 子进程启动、主机平台准入、浅检测/深检、模型目录缓存、检查 attempt、公开 Runtime failure、Session continuation/cold resume、replay quarantine、静态 Installation、`light_ready`/`installed_unverified`、执行期验证或 nullable Runtime version | [ADR-0210](adr/0210-platform-qualified-product-runtime-admission.md)、[ADR-0211](adr/0211-atomic-windows-managed-process-launch.md)、[Managed Runtime Process v1](contracts/managed-runtime-process-v1.md)、[Runtime Platform Admission v1](contracts/runtime-platform-admission-v1.md)、[ADR-0204](adr/0204-on-demand-runtime-deep-verification.md)、[ADR-0220](adr/0220-runtime-model-catalog-stale-while-revalidate.md)、[ADR-0192](adr/0192-purpose-scoped-runtime-launch-and-execution-deferred-verification.md)、[Runtime Launch and Verification v9](contracts/runtime-launch-and-verification-v9.md)及[Runtime Catalog Boundaries](architecture/runtime-catalog-boundaries.md) |
| 修改队员 Runtime 权限默认、模型 Picker、Kiro trust-all、TRAE permission mode 或 permission schema drift | [ADR-0207](adr/0207-explicit-maximum-authority-member-runtime-defaults.md)、[ADR-0220](adr/0220-runtime-model-catalog-stale-while-revalidate.md)、[Runtime Launch and Verification v9](contracts/runtime-launch-and-verification-v9.md)、[Runtime Catalog Boundaries](architecture/runtime-catalog-boundaries.md)及[队员工作区 brief](../apps/desktop/.impeccable/surfaces/member-workspace.md) |
| 修改 Camp 主键、`CampId/campId/camp_id`、Camp 文件路径、本机 Camp locator 或 Camp/Native Session identity seam | [Camp Identity v1](contracts/camp-identity-v1.md)、[Camp Identity Architecture](architecture/camp-identity.md)、[ADR-0219](adr/0219-single-namespaced-camp-identity.md)及当前 Context/History/Built-in 合同 |
...
| 修改内置 Agent CLI、IPC、Envelope、receipt、Projection、Gather、队员创建或幂等合同 | [Built-in Tool Transport v16 合同](contracts/builtin-tool-transport-v16.md)、[ADR-0217](adr/0217-transport-v15-inherits-cross-platform-v14.md)、[Gather v3](contracts/gather-v3.md)、[ADR-0191](adr/0191-agent-mediated-member-creation-and-thirteen-skill-inventory.md)、[Camp Message Send v10](contracts/camp-message-send-v10.md)及[Current User Attention v4](contracts/current-user-attention-v4.md) |
| 修改 `camp.search`、`camp.read`、`history.search`、Agent/Human Principal message projection、跨 Camp Manifest/live authorization、Public A2A 历史可见性、Camp message publication fence 或 Agent read 附件输出 | [Camp History Retrieval v3](contracts/camp-history-v3.md)、[ADR-0218](adr/0218-audience-specific-principal-message-projection.md)、[ADR-0215](adr/0215-unified-single-camp-history-target-and-publication-boundary.md)、[ADR-0106](adr/0106-agent-bounded-cross-camp-public-history-retrieval.md)、[ADR-0108](adr/0108-discovery-only-camp-message-search-and-sequence-paged-reads.md)、[ADR-0130](adr/0130-public-a2a-message-and-unified-delivery.md)、[Built-in Tool Runtime](architecture/builtin-tool-runtime.md)及[Public A2A Message Delivery](architecture/public-a2a-message-delivery.md) |
...
| 修改 Camp 文件/目录附件、Composer 拖放、快照限制、Agent read 附件摘要或 Runtime 附件路径 | [Camp Attachment v1](contracts/camp-attachment-v1.md)、[Camp History Retrieval v3](contracts/camp-history-v3.md)、[Camp Identity v1](contracts/camp-identity-v1.md)、[ADR-0169](adr/0169-core-owned-directory-attachment-snapshots.md)及[会话区拖放 UI](ui/components/conversation-drop-zone.md) |
...
| 修改 Desktop 当前 Camp `Command/Ctrl+F`、完整会话正文 exact count、命中遍历、地图快捷返回或旧消息 anchored 定位 | [Camp Conversation Find v1](contracts/camp-conversation-find-v1.md)、[Camp Open Read Path](architecture/camp-open-read-path.md)、[Camp 会话工作区](ui/components/conversation-workspace.md)、[ADR-0013](adr/0013-managed-content-and-read-side-v2.md)及[ADR-0108](adr/0108-discovery-only-camp-message-search-and-sequence-paged-reads.md) |
| 修改 Camp 永久删除、强制删除、quiescence blocker、删除后的 Runtime 收敛或受管资源清理 | [Camp Permanent Deletion v1](contracts/camp-permanent-deletion-v1.md)、[ADR-0206](adr/0206-user-confirmed-force-camp-deletion.md)、[ADR-0058](adr/0058-collaboration-v4-presence-aware-admission.md)、[ADR-0079](adr/0079-two-phase-cancellation-projection-and-bounded-runtime-interrupt.md)及[ADR-0123](adr/0123-exclusive-agentrun-runtime-fleet.md) |
| 修改首次安装判断、新手训练页、断点恢复、首次队员/Runtime provisioning、`初次集结` 或 starter Draft 行为 | [First-run Onboarding v1](contracts/first-run-onboarding-v1.md)、[First-run Onboarding 架构](architecture/first-run-onboarding.md)、[首次训练 UI](ui/components/first-run-onboarding.md)、[ADR-0071](adr/0071-configured-camp-creation-and-lazy-conversations.md)、[ADR-0083](adr/0083-background-runtime-checks-and-actionable-status.md)及[Camp Composer Draft v2](contracts/camp-composer-draft-v2.md) |
...
| 修改 Composer Skill Picker 的结构化身份、发送时资格、`CURRENT_INPUT.skills` 文件链接或对应 Manifest Evidence | 先按[核心模型上下文变更治理](development/model-context-change-governance.md)确认 revision，再读[ADR-0203](adr/0203-structured-current-input-skill-links.md)、[Current Input Skill Links v1](contracts/current-input-skill-links-v1.md)、[ContextManifest Evidence v18](contracts/context-manifest-evidence-v18.md)、[Structured Current Input Skill Links 架构](architecture/structured-current-input-skill-links.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
| 修改 CLI 教学分层、Agent inline 寻址、协作 Skill 消息拓扑、`cli-operations` 触发/reference，或 official Skill 精确集合、固定 GitHub 来源与管理策略 | [ADR-0163](adr/0163-explicit-caller-return-and-core-managed-reply-reference.md)、[ADR-0166](adr/0166-progressive-built-in-cli-teaching.md)、[ADR-0182](adr/0182-core-resolved-current-camp-display-name-inline-addressing-alias.md)、[ADR-0184](adr/0184-line-leading-display-name-inline-addressing-alias.md)、[ADR-0191](adr/0191-agent-mediated-member-creation-and-thirteen-skill-inventory.md)及[Built-in Tool Runtime 架构](architecture/builtin-tool-runtime.md) |
...
| 修改 Gather Barrier、return capture、Completion Delivery/Run、AgentRun 公共消息/Task 选择、正文/历史预算、引用链或投递 Profile | [持久 Gather Barrier](architecture/durable-gather-barrier.md)、[Gather v3](contracts/gather-v3.md)、[ADR-0193](adr/0193-durable-gather-barrier-over-unified-message-delivery.md)、[ADR-0195](adr/0195-generation-scoped-last-gather-return.md)、[ADR-0196](adr/0196-self-contained-gather-completion-request.md)、[Context Delivery Profile v3](contracts/context-delivery-profile-v3.md)及[Message Delivery v4](contracts/message-delivery-v4.md) |
| 修改 Native Session Bootstrap、AgentRun Dynamic Context、模型可见字段/JSON、历史截断/遗漏、ContextManifest Evidence、Runtime Input Delivery Evidence 或 Formatter/Manifest/Profile 版本边界 | 先按[核心模型上下文变更治理](development/model-context-change-governance.md)建立独立说明并取得二次确认，再读[CURRENT 上下文主题](adr/CURRENT.md)、当前 ContextManifest/Run Facts 合同及当前版本实施计划 |
...
| 修改 Benchmark 协议、Judge View、Tool-use/协作测量、Team/Solo paired experiment、Profile、比较资格、失败分类或 Project Review 投影 | [ADR-0151](adr/0151-versioned-benchmark-protocol-and-axis-comparability.md)、[ADR-0155](adr/0155-treatment-blind-outcome-and-process-judge-views.md)、[ADR-0171](adr/0171-opportunity-based-tool-interaction-measurement.md)、[ADR-0172](adr/0172-paired-collaboration-value-and-outcome-conditioned-efficiency.md)、[Benchmark Protocol v3](contracts/benchmark-protocol-v3.md)、[Semantic Judge Views v1](contracts/semantic-judge-views-v1.md)、[Tool Interaction Measurement v2](contracts/tool-interaction-measurement-v2.md)、[Paired Collaboration Experiment v1](contracts/paired-collaboration-experiment-v1.md)及[Benchmark Protocol 架构](architecture/benchmark-protocol.md) |
...
| 修改主动退出/重启/更新、Core drain、launch/terminal admission、Runtime planned stop、durable shutdown fence、shutdown deadline 或 Desktop child-exit wait | [Planned Shutdown 架构](architecture/planned-shutdown.md)、[ADR-0168](adr/0168-planned-shutdown-preserves-runtime-terminal-authority.md)、[ADR-0177](adr/0177-controlled-shutdown-fences-product-execution.md)及[Planned Shutdown v2](contracts/planned-shutdown-v2.md) |
...
| 修改 Windows x64 Desktop、Named Pipe、Job、DACL、data root、Skill copy、NSIS、签名或 Windows 交互差异 | [Windows Desktop Platform](architecture/windows-desktop-platform.md)、[v1.05](versions/v1.05/README.md)、[Windows Interaction Delta](ui/windows-interaction-delta.md)及相应 ADR/Contract |
