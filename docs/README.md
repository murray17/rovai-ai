...
| 修改内置 Agent CLI、IPC、Envelope、receipt、Projection、Gather、定时 Automation、队员创建、纯附件 Agent Send 或幂等合同 | [Built-in Tool Transport v22 合同](contracts/builtin-tool-transport-v22.md)、[Built-in 运输不变量](architecture/foundational-invariants.md#skills-builtin-transport)、[Gather v5](contracts/gather-v5.md)、[Skill Library 与投影不变量](architecture/foundational-invariants.md#skills-library-projection)、[Camp Message Send v19](contracts/camp-message-send-v19.md)及[Current User Attention v4](contracts/current-user-attention-v4.md) |
