...
| 修改内置 Agent CLI、IPC、Envelope、receipt、Projection 或幂等合同 | [Built-in Tool Transport v8 合同](contracts/builtin-tool-transport-v8.md)、[Camp Message Send v5](contracts/camp-message-send-v5.md)及[Current User Attention v2](contracts/current-user-attention-v2.md) |
