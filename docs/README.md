...
| 任务 | 必读资料 |
|---|---|
| 修改 Runtime 结构化图片、原生生图自动展示准入、混合临时文件生命周期、Run 图片读取、图片附件 Gallery、消息附件分区/几何或本地图片与飞书显式文件交付边界 | [Runtime 图片架构](architecture/runtime-images.md)、[Runtime Images v5](contracts/runtime-images-v5.md)、[Camp Open Projection v16](contracts/camp-open-projection-v16.md)、[v1.53 范围](versions/v1.53/README.md)及[统一图片与文件展示](ui/components/conversation-workspace.md#runtime-图片与消息图片) |
...
| 修改 AgentRun 局部停止入口、直接提交、权威停止状态，实际模型观测、命令/搜索详情、Tool 聚合、状态图形、文件入口、纯读取 Shell 摘要、Runtime Compaction 本地展示、运行中 Runtime diagnostic、首值冻结、默认策略回退、执行台位置偏好、进入恢复或模型展示 | [Runtime Catalog 与 Installation 不变量](architecture/foundational-invariants.md#runtime-catalog-installation)、[产品/执行表面不变量](architecture/foundational-invariants.md#product-execution-surface)、[Runtime Catalog Boundaries](architecture/runtime-catalog-boundaries.md)、[Run Process Detail Surface v31](contracts/run-process-detail-surface-v31.md)、[Camp Open Projection v16](contracts/camp-open-projection-v16.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
| 修改 Runtime-reported 文件操作、Command Diff、AgentRun 文件变化卡片、managed output 排除、归约/读取授权或文件变化呈现 | [Runtime File Change Observation v3](contracts/runtime-file-change-observation-v3.md)、[Runtime File Change Observation 架构](architecture/runtime-file-change-observation.md)、[Evidence/Activity 不变量](architecture/foundational-invariants.md#evidence-canonical-activity)、[Camp 会话工作区](ui/components/conversation-workspace.md)及[v1.54 当前范围](versions/v1.54/README.md) |
| 修改 Camp 文件预览、窗口内 Tab 恢复、项目内子文件独立恢复、owner-scoped 附件打开、消息文件打开、具体文件能力、预览句柄/分页/Root Grant、HTML 沙箱、root watcher、文件 Tabs 或刷新 | [File Preview v8](contracts/file-preview-v8.md)、[File Preview Architecture](architecture/file-preview.md)、[Camp 文件预览区](ui/components/file-preview.md)、[Camp 会话工作区](ui/components/conversation-workspace.md)、[v1.52 文件预览范围](versions/v1.52/README.md)及[v1.30 初始实施](versions/v1.30/implementation-plan.md) |
