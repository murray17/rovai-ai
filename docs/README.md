...
| 任务 | 必读资料 |
|---|---|
| 修改 Runtime 结构化图片、混合临时文件生命周期、Run 图片读取、图片附件 Gallery 或本地图片与飞书显式文件交付边界 | [Runtime 图片架构](architecture/runtime-images.md)、[Runtime Images v2](contracts/runtime-images-v2.md)、[Camp Open Projection v11](contracts/camp-open-projection-v11.md)及[统一图片展示](ui/components/conversation-workspace.md#runtime-图片与消息图片) |
