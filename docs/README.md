...
| 修改内置 Agent CLI、IPC、Envelope、receipt、Projection 或幂等合同 | [Built-in Tool Transport v8 合同](contracts/builtin-tool-transport-v8.md)、[Camp Message Send v5](contracts/camp-message-send-v5.md)及[Current User Attention v3](contracts/current-user-attention-v3.md) |
| 修改通知来源、Episode 聚合、未读/清除、增量、浮层设置或类型化导航 | [Notification Episode v1](contracts/notification-episode-v1.md)、[ADR-0175](adr/0175-core-owned-notification-occurrence-episode-and-change-journal.md)及[Notification Episode 架构](architecture/notification-episodes.md) |
...
| 修改 CLI 教学分层、`cli-operations` 触发/reference，或 official Skill 精确集合、固定 GitHub 来源与普通投递 | [ADR-0166](adr/0166-progressive-built-in-cli-teaching.md)、[ADR-0174](adr/0174-ten-skill-official-inventory-and-pinned-matt-pocock-imports.md)及[Built-in Tool Runtime 架构](architecture/builtin-tool-runtime.md) |
