...
| 修改内置 Agent CLI、IPC、Envelope、receipt、Projection、Gather、队员创建或幂等合同 | [Built-in Tool Transport v13 合同](contracts/builtin-tool-transport-v13.md)、[Gather v1](contracts/gather-v1.md)、[ADR-0191](adr/0191-agent-mediated-member-creation-and-thirteen-skill-inventory.md)、[Camp Message Send v8](contracts/camp-message-send-v8.md)及[Current User Attention v4](contracts/current-user-attention-v4.md) |
...
| 修改 Gather Barrier、return capture、Completion Delivery/Run、AgentRun 公共消息/Task 选择、正文/历史预算、引用链或投递 Profile | [持久 Gather Barrier](architecture/durable-gather-barrier.md)、[ADR-0193](adr/0193-durable-gather-barrier-over-unified-message-delivery.md)、[ADR-0194](adr/0194-mandatory-typed-gather-completion-current-input.md)、[Context Delivery Profile v3](contracts/context-delivery-profile-v3.md)及[Message Delivery v3](contracts/message-delivery-v3.md) |
| 修改模型可见上下文字段/JSON、Gather completion input、截断 continuation、遗漏 navigation hint、ContextManifest Evidence、Runtime Input Delivery Evidence 或 Formatter/Manifest/Profile 版本边界 | [ADR-0147](adr/0147-lossless-model-context-projection-and-layered-delivery-evidence.md)、[ADR-0149](adr/0149-bounded-whole-history-omission-evidence.md)、[ADR-0194](adr/0194-mandatory-typed-gather-completion-current-input.md)、[ContextManifest Evidence v13](contracts/context-manifest-evidence-v13.md)及当前版本实施计划 |
