...
| 修改飞书、Lark 或钉钉渠道、渠道 credential/Developer Session 存储、队员 Bot、Owner identity、OAuth、Quick Chat/Project Catalog、PendingCampBinding、渠道会话、ExternalPrincipal、多 Bot、ChannelTurnRequest、群 roster、执行控制台、永久输出/附件、卡片/Outbox 或渠道设置 UI | 先读 [Channel Message Bridge v1](contracts/channel-message-bridge-v1.md)与[Channel Storage v3](contracts/channel-storage-v3.md)，再按 Provider 读取 [Feishu Channel v17](contracts/feishu-channel-v17.md)与[飞书渠道架构](architecture/feishu-channel.md)，[Lark Channel v1](contracts/lark-channel-v1.md)与[Lark 渠道架构](architecture/lark-channel.md)，或 [DingTalk Channel v13](contracts/dingtalk-channel-v13.md)与[钉钉渠道架构](architecture/dingtalk-channel.md)；共享边界继续读[Camp Membership v2](contracts/camp-membership-v2.md)、[Camp Attachment v10](contracts/camp-attachment-v10.md)、[ContextManifest Evidence v31](contracts/context-manifest-evidence-v31.md)及[渠道设置](ui/components/channel-settings.md) |
...
| 修改通知来源、Episode 聚合、未读/清除、会话可见确认、增量、浮层设置或类型化导航 | [Notification Episode v9](contracts/notification-episode-v9.md)、[Current User Attention v8](contracts/current-user-attention-v8.md)、[通知事实与投影](architecture/foundational-invariants.md#core-notifications)及[Notification Episode 架构](architecture/notification-episodes.md) |
