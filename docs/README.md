...
| 判断当前版本目标、范围、进度或验收口径 | [当前版本 v0.08](versions/v0.08/README.md)、[架构协议](versions/v0.08/architecture.md)及[实施计划](versions/v0.08/implementation-plan.md)；当前实施到检查点 3/5 |
