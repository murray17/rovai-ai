...
| 修改 Runtime Usage、监控 collection、Coverage、Tool duration、成本层或设置页运行监控 | [ADR-0201](adr/0201-sparse-runtime-usage-and-clean-break-monitoring.md)、[Runtime Monitoring 架构](architecture/runtime-monitoring.md)、[Runtime Monitoring v1](contracts/runtime-monitoring-v1.md)及[可采集性审计](research/runtime-monitoring/README.md) |
