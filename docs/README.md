...
| 修改 `MEMBER_IDENTITY`、`COLLABORATION_STATE`、peer 选择、Lead 引用、projection digest/inclusion 或 accepted ACK 水位 | [ADR-0145](adr/0145-sole-native-session-self-identity-and-peer-routing-projection.md)、[Collaboration State v2](contracts/collaboration-state-v2.md)及[Built-in Tool Runtime 架构](architecture/builtin-tool-runtime.md) |
