...
| 修改内置 Agent CLI、IPC、Envelope、receipt、Projection、Gather、队员创建或幂等合同 | [Built-in Tool Transport v18 合同](contracts/builtin-tool-transport-v18.md)、[Built-in 运输不变量](architecture/foundational-invariants.md#skills-builtin-transport)、[Gather v3](contracts/gather-v3.md)、[Skill Library 与投影不变量](architecture/foundational-invariants.md#skills-library-projection)、[Camp Message Send v11](contracts/camp-message-send-v11.md)及[Current User Attention v4](contracts/current-user-attention-v4.md) |
...
| 修改 Camp 文件/目录附件、Draft/Published 授权、Composer/Agent ingress、快照限制、Runtime availability、publication recovery、Runtime View 或模型附件路径 | [Camp Attachment v3](contracts/camp-attachment-v3.md)、[Camp Published Attachment View v3](contracts/camp-published-attachment-view-v3.md)、[Camp Published Attachment View 架构](architecture/camp-published-attachment-view.md)、[ContextManifest Evidence v21](contracts/context-manifest-evidence-v21.md)、[Camp History Retrieval v4](contracts/camp-history-v4.md)、[Camp Identity v1](contracts/camp-identity-v1.md)、[Camp 资源不变量](architecture/foundational-invariants.md#camp-resources)及[会话区拖放 UI](ui/components/conversation-drop-zone.md) |
| 修改用户消息回复、接收者延续、Composer 路由优先级、纯附件发送、失效换人或 Draft-only user send | [Composer Draft 不变量](architecture/foundational-invariants.md#camp-composer)、[Camp Composer Draft v4](contracts/camp-composer-draft-v4.md)、[Camp Composer Draft 架构](architecture/camp-composer-draft.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
| 修改 Camp 打开、冷启动恢复壳层、投影/存在性检查、会话历史分页、运行中 Evidence、high-water/cache 或首屏性能日志 | [Camp Open Projection v6](contracts/camp-open-projection-v6.md)、[Camp Open Read Path](architecture/camp-open-read-path.md)、[Core 受管内容不变量](architecture/foundational-invariants.md#core-managed-content)、[协作与执行准入不变量](architecture/foundational-invariants.md#collaboration-admission)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
...
| 修改 Gather Barrier、return capture、Completion Delivery/Run、Attachment projection gate、AgentRun 公共消息/Task 选择、正文/历史预算、引用链或投递 Profile | [持久 Gather Barrier](architecture/durable-gather-barrier.md)、[Gather v3](contracts/gather-v3.md)、[Gather 不变量](architecture/foundational-invariants.md#collaboration-gather)、[ContextManifest 与 Run Facts 不变量](architecture/foundational-invariants.md#context-manifest-run-facts)、[Context Delivery Profile v4](contracts/context-delivery-profile-v4.md)及[Message Delivery v5](contracts/message-delivery-v5.md) |
...
| 修改 AgentRun 局部停止入口、直接提交、权威停止状态，实际模型观测、命令展示、首值冻结、默认策略回退、执行台位置偏好、进入恢复或模型展示 | [Runtime Catalog 与 Installation 不变量](architecture/foundational-invariants.md#runtime-catalog-installation)、[产品/执行表面不变量](architecture/foundational-invariants.md#product-execution-surface)、[Runtime Catalog Boundaries](architecture/runtime-catalog-boundaries.md)、[Run Process Detail Surface v17](contracts/run-process-detail-surface-v17.md)、[Camp Open Projection v6](contracts/camp-open-projection-v6.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
