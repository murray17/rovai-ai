...
| 修改 Runtime Usage、监控 collection、Coverage、成本层或设置页运行监控 | [ADR-0205](adr/0205-minimal-runtime-usage-metering.md)、[Runtime Monitoring 架构](architecture/runtime-monitoring.md)、[Runtime Usage Monitoring v2](contracts/runtime-usage-monitoring-v2.md)及[可采集性审计](research/runtime-monitoring/README.md) |
| 修改 Runtime 子进程启动、浅检测/深检、检查 attempt、静态 Installation、`light_ready`/`installed_unverified`、执行期验证或 nullable Runtime version | [ADR-0204](adr/0204-on-demand-runtime-deep-verification.md)、[ADR-0192](adr/0192-purpose-scoped-runtime-launch-and-execution-deferred-verification.md)、[ADR-0207](adr/0207-explicit-maximum-authority-member-runtime-defaults.md)、[Runtime Launch and Verification v4](contracts/runtime-launch-and-verification-v4.md)及[Runtime Catalog Boundaries](architecture/runtime-catalog-boundaries.md) |
| 修改队员 Runtime 权限默认、Kiro trust-all、TRAE permission mode 或 permission schema drift | [ADR-0207](adr/0207-explicit-maximum-authority-member-runtime-defaults.md)、[Runtime Launch and Verification v4](contracts/runtime-launch-and-verification-v4.md)、[Runtime Catalog Boundaries](architecture/runtime-catalog-boundaries.md)及[队员工作区 brief](../apps/desktop/.impeccable/surfaces/member-workspace.md) |
