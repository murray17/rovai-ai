...
| 历史 ID | 决策 | 迁移时状态 |
| --- | --- | --- |
| [ADR-0088](#adr-0088) | Attested Native Team Gateway Attachment | `accepted` |

<!-- legacy-adr:begin id=ADR-0088 source-file-sha256=4b0f372b7b59791161c72821c50c3ed889b1057af246f227403b30f78fe26eb1 -->
<a id="adr-0088"></a>

## ADR-0088: Attested Native Team Gateway Attachment

迁移时原路径：`docs/adr/0088-attested-native-team-gateway-attachment.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<a id="adr-0088-decision"></a>
### Decision

<a id="adr-0088-三个能力轴独立冻结"></a>
#### 三个能力轴独立冻结
...
<a id="adr-0088-只挂接一个无凭据的内部-bridge"></a>
#### 只挂接一个无凭据的内部 Bridge
...
<a id="adr-0088-原生配置采用保留-ambient-的受管合并"></a>
...
<a id="adr-0088-core-以-os-进程身份建立连接绑定"></a>
...
<a id="adr-0088-原生权限必须窄授权且单独同意"></a>
#### 原生权限必须窄授权且单独同意
...
<a id="adr-0088-attachment-与工具合同按-sessionrun-冻结"></a>
...
<a id="adr-0088-以真实证据准入不按-runtime-名称猜测"></a>
...
<a id="adr-0088-rejected-alternatives"></a>
...
<a id="adr-0088-references"></a>
### References

- [v0.30 Attested Native Team Bridge](README.md)
...
<!-- legacy-adr-body:end id=ADR-0088 -->
<!-- legacy-adr:end id=ADR-0088 -->
