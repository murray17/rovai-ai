...
| Decisions | 已更新 | [V1.29-D01](decisions.md#v1-29-d01)冻结两层 diff 与既有 Canonical Activity 权威；[V1.29-D02](decisions.md#v1-29-d02)冻结 Camp/exact-root Window、受控 Git checkpoint 和 fail-open Coordinator；[V1.29-D03](decisions.md#v1-29-d03)冻结终态文件行与历史卡片交互。 |
