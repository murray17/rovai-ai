...
- `cargo test -p rovai-core --features slow-tests --lib slow_tests::`：282/282 通过，覆盖动态 membership、
  exact-run business-tool fence、Delivery/Gather settlement 与 Missing-Send Recovery publication fence；
- `DOCS_BASE_REF=cc9495d1a7790927689c3da3434b0515c8d09877 pnpm docs:check:ci` 通过；
