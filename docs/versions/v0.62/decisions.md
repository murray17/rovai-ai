...
| 历史 ID | 决策 | 迁移时状态 |
| --- | --- | --- |
| [ADR-0163](#adr-0163) | Explicit Caller Return and Core-Managed Reply Reference | `accepted` |

<!-- legacy-adr:begin id=ADR-0163 source-file-sha256=964b09d4492fcbd7638b0514c7916325a3cfbc55648bc9a202589da60881b82d -->
<a id="adr-0163"></a>

## ADR-0163: Explicit Caller Return and Core-Managed Reply Reference

迁移时原路径：`docs/adr/0163-explicit-caller-return-and-core-managed-reply-reference.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<!-- legacy-adr-body:begin id=ADR-0163 -->
<a id="adr-0163-context"></a>
### Context
...
<a id="adr-0163-rejected-alternatives"></a>
...
<a id="adr-0163-references"></a>
### References

- [v0.62 版本目标](README.md)
- [ADR-0130：Public A2A Message 与统一 Delivery](../v0.45/decisions.md#adr-0130)
- [ADR-0131：recipient-scoped Delivery 恢复](../v0.45/decisions.md#adr-0131)
- [ADR-0132：公共引用 Context Closure](../v0.45/decisions.md#adr-0132)
- [ADR-0162：Missing-Send Recovery Publication](../v0.59/decisions.md#adr-0162)
- [Camp Message Send v3](../../contracts/camp-message-send-v3.md)
- [Message Delivery v2](../../contracts/message-delivery-v2.md)
<!-- legacy-adr-body:end id=ADR-0163 -->
<!-- legacy-adr:end id=ADR-0163 -->
