...
- [全局设计系统](../../../DESIGN.md)
- [Agent 级连续执行过程 ADR-0154](../../adr/0154-agent-level-execution-process-surface.md)
- [聚焦 Inspector 与唯一 Approval Surface ADR-0160](../../adr/0160-focused-camp-inspector-and-single-approval-surface.md)
- [Core-owned Runtime Activity ADR-0111](../../adr/0111-core-owned-canonical-runtime-activity.md)
- [公共 A2A 与统一 Message Delivery ADR-0130](../../adr/0130-public-a2a-message-and-unified-delivery.md)
