...
前置：[v1.56](../v1.56/README.md)。本版本实现[四项治理愿景](../../research/agent-governance-vision.md)中的第二项：Gate／每周真实任务回归与每日 Trace 规则分析。长期规则见 [Execution Evaluation v13](../../contracts/execution-evaluation-v13.md)，操作见[开发指南](../../development/evaluation.md)。
