...
| 历史 ID | 决策 | 迁移时状态 |
| --- | --- | --- |
| [ADR-0209](#adr-0209) | Bounded TRAE Cold Session History Restore | `accepted` |

<!-- legacy-adr:begin id=ADR-0209 source-file-sha256=5a67fd056f63569933ba71953d367ba740d647f1b9017ec730d1ebfb66c5285b -->
<a id="adr-0209"></a>

## ADR-0209: Bounded TRAE Cold Session History Restore

迁移时原路径：`docs/adr/0209-bounded-trae-cold-session-history-restore.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<!-- legacy-adr-body:begin id=ADR-0209 -->
<a id="adr-0209-context"></a>
### Context
...
<a id="adr-0209-rejected-alternatives"></a>
...
<a id="adr-0209-references"></a>
### References

- [v1.04 version scope](README.md)
...
- [ADR-0203](../v0.98/decisions.md#adr-0203)
<!-- legacy-adr-body:end id=ADR-0209 -->
<!-- legacy-adr:end id=ADR-0209 -->
