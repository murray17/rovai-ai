...
| UI | 已更新 | [Camp 会话工作区](../../ui/components/conversation-workspace.md)补充活动 Tool 组的具体当前指令、稳定 Tool 行与渠道边界；[Camp 文件预览区](../../ui/components/file-preview.md)拥有真实文件链接和共享图标语义；Pi 仍只复用既有 Runtime/成员/监控表面 |
