...
| Decisions | 已更新 | [v1.39 决定](decisions.md)记录独立 JSONL Host、私有 exact resume、managed receipt、MCP bridge、消息文件存在性边界和 Pi 三平台可运行 Preview；CURRENT 已纳入导航 |
...
| UI | 已更新 | [Camp 会话工作区](../../ui/components/conversation-workspace.md)补充活动 Tool 组的具体当前指令、稳定 Tool 行、渠道边界和世界地图首次默认；[Camp 文件预览区](../../ui/components/file-preview.md)拥有真实文件链接和共享图标语义；Pi 在既有 Runtime、成员与 onboarding 表面标记“实验性开放” |
...
| Documentation routing | 已更新 | [文档导航](../../README.md)、Contract/Architecture 索引和当前决定导航指向 Runtime Launch v31、Platform Admission v2、File Preview v4、Pi research 与 parity matrix |
