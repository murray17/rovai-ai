...
<a id="v1-34-d01"></a>
## V1.34-D01：钉钉控制面由 Main 直接拥有 OAuth 与官方开发者 API
...
<a id="v1-34-d02"></a>
## V1.34-D02：Provider 专属身份与传输，复用同一个 Core admission/Outbox
...
<a id="v1-34-d04"></a>
## V1.34-D04：渠道秘密统一进入现有 SQLite，不依赖系统凭据库
...
该决定局部替代本文件 V1.34-D01 中 Token/Secret 不进入 Core、使用 OS safeStorage 的条款，以及 v1.30 飞书决定中相同的
