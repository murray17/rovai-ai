...
- 飞书终态执行卡按 [Feishu Channel v6](../../contracts/feishu-channel-v6.md) 在总折叠中混排公开文字与单条 command
...
| Decisions | 已更新 | [v1.34 决定](decisions.md)记录 Main 控制面、provider-neutral Core 复用、SQLite 和未实测能力 fail-closed；D05 记录 Web Session 替代 OAuth 的授权/协议漂移取舍。 |
