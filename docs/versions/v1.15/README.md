...
| Contracts | 已更新 | [Windows Skill Projection v1](../../contracts/windows-skill-projection-v1.md)把 Migration 97 目标推进到 Data Contract v1.15/schema 52；[Run Process Detail Surface v12](../../contracts/run-process-detail-surface-v12.md)把 AgentRun Stop 收敛为单击直接提交。 |
...
| UI | 已更新 | [Camp 会话工作区](../../ui/components/conversation-workspace.md)移除 AgentRun Stop 确认层；底部与 Inspector 保留同一直接停止入口和权威状态投影。 |
