...
| 范围 | 结论 | 证据或理由 |
| --- | --- | --- |
| Version lifecycle | 已更新 | v1.43 冻结为 historical；本概览、[实施计划](implementation-plan.md)、版本索引与前后链接建立唯一 current v1.44 |
| Decisions | 已更新 | [V1.44-D01](decisions.md#v1-44-d01)记录 Pi 原生资源和普通 Prompt 边界；[V1.44-D02](decisions.md#v1-44-d02)记录 Fleet Reserve/Spawn/Commit；CURRENT 已纳入导航 |
...
| Documentation routing | 已更新 | 文档总导航、Contracts 索引、当前决定导航与 Pi research matrix 均指向 Runtime Launch v34/current v1.44 |
