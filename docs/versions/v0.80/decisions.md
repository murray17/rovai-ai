...
| 历史 ID | 决策 | 迁移时状态 |
| --- | --- | --- |
| [ADR-0187](#adr-0187) | Durable Composer Recipient Continuation | `accepted` |

<!-- legacy-adr:begin id=ADR-0187 source-file-sha256=d1157da0e9d96f460d2ab4f0290c44fe3ac8cfa66817251a31064b65d10589c1 -->
<a id="adr-0187"></a>

## ADR-0187: Durable Composer Recipient Continuation

迁移时原路径：`docs/adr/0187-durable-composer-recipient-continuation.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<!-- legacy-adr-body:begin id=ADR-0187 -->
<a id="adr-0187-context"></a>
### Context
...
<a id="adr-0187-rejected-alternatives"></a>
...
<a id="adr-0187-references"></a>
### References

- [v0.80 版本目标](README.md)
...
- [ADR-0185: Durable Composer Reply Intent](../v0.77/decisions.md#adr-0185)
- [ADR-0058: Presence-Aware Routing and Execution Admission](../v0.15/decisions.md#adr-0058)
<!-- legacy-adr-body:end id=ADR-0187 -->
<!-- legacy-adr:end id=ADR-0187 -->
