...
| 历史 ID | 决策 | 迁移时状态 |
| --- | --- | --- |
| [ADR-0048](#adr-0048) | Rovai-ai Product Identity and Controlled Legacy Namespace Migration | `accepted` |

<!-- legacy-adr:begin id=ADR-0048 source-file-sha256=d54bfdd510da97dc0588eb65694421fe5b3d8e646b1428d8033c0354d8583889 -->
<a id="adr-0048"></a>

## ADR-0048: Rovai-ai Product Identity and Controlled Legacy Namespace Migration

迁移时原路径：`docs/adr/0048-rovai-product-identity-and-legacy-namespace.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<!-- legacy-adr-body:begin id=ADR-0048 -->
<a id="adr-0048-context"></a>
### Context
...
<a id="adr-0048-rejected-alternatives"></a>
...
<a id="adr-0048-references"></a>
### References

- [v0.11 Rovai-ai 产品更名](README.md)
- [UI 规范](../../ui/README.md)
...
<!-- legacy-adr-body:end id=ADR-0048 -->
<!-- legacy-adr:end id=ADR-0048 -->
