...
| 历史 ID | 决策 | 迁移时状态 |
| --- | --- | --- |
| [ADR-0186](#adr-0186) | Complete Exact-Scope Memory View and Copyable Revision Target | `accepted` |

<!-- legacy-adr:begin id=ADR-0186 source-file-sha256=f44cb8f6d3aa331e25661dacfae0bcccca5beff54d53756b2fde1c1056ca5296 -->
<a id="adr-0186"></a>

## ADR-0186: Complete Exact-Scope Memory View and Copyable Revision Target

迁移时原路径：`docs/adr/0186-complete-exact-scope-memory-view-and-copyable-target.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<!-- legacy-adr-body:begin id=ADR-0186 -->
<a id="adr-0186-context"></a>
### Context
...
<a id="adr-0186-rejected-alternatives"></a>
...
<a id="adr-0186-references"></a>
### References

- [v0.78 current version](README.md)
- [Memory Capture v3](../../contracts/memory-capture-v3.md)
- [Built-in Tool Transport v11](../../contracts/builtin-tool-transport-v11.md)
- [ADR-0068: Brokered Memory Retrieval](../v0.21/decisions.md#adr-0068)
- [ADR-0178: Best-Effort Online Memory Capture](../v0.73/decisions.md#adr-0178)
- [ADR-0183: Scope-Identified Agent Memory Revision Targets](../v0.75/decisions.md#adr-0183)
- [Online Memory Capture architecture](../../architecture/online-memory-capture.md)
<!-- legacy-adr-body:end id=ADR-0186 -->
<!-- legacy-adr:end id=ADR-0186 -->
