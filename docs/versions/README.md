...
| v1.30 | `current` | 飞书 Developer Session 与独立队员 Bot、Owner-only Quick Chat/项目卡、多 Bot 聚合、串行 Camp admission、ExternalQuote、临时执行控制台与永久输出/附件 Outbox | [v1.30/README.md](v1.30/README.md) |
