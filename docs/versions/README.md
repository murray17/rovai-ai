...
| v1.29 | `historical` | 动态 Camp membership 与 Managed Attachment v2 已完成；Runtime Evidence 驱动的 Command Diff 与每 AgentRun 文件变化卡片已实现，冻结时真实 Runtime 验收仍在进行 | [v1.29/README.md](v1.29/README.md) |
