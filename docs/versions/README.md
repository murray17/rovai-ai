...
| v1.31 | `current` | Desktop Bootstrap/Full Core 分层、SQLite lease/admission/copy migration、Supervisor fencing 与本机偏好 fail-open 正在收口 | [v1.31/README.md](v1.31/README.md) |
