...
| v1.29 | `historical` | 已完成的 Camp 动态添加与移除队员、原子 cutover、持久 reconciliation、exact membership lifetime fence 与会话区管理交互 | [v1.29/README.md](v1.29/README.md) |
| v1.30 | `current` | 飞书独立队员 Bot、owner-only ProjectBinding、多 Bot 聚合、串行 Camp admission、ExternalQuote 与可靠 Outbox | [v1.30/README.md](v1.30/README.md) |
