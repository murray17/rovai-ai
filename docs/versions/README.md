...
| v1.30 | `current` | 飞书 Developer Session 与独立队员 Bot、owner-only ProjectBinding、多 Bot 聚合、串行 Camp admission、ExternalQuote 与可靠 Outbox | [v1.30/README.md](v1.30/README.md) |
