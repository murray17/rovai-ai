...
| v1.29 | `current` | 动态 Camp membership、Runtime 文件变化与 Activity v2 新写入已实现；typed query、Renderer 中文标题和七类图标完成定向回归，真实 Runtime 验收仍在进行 | [v1.29/README.md](v1.29/README.md) |
