...
| v1.39 | `current` | Pi JSONL Runtime、managed system prompt、exact resume、动态 Skills/MCP、Core Approval 与稀疏 Usage；三平台保持未准入；Renderer 附件按作者分区展示 | [v1.39/README.md](v1.39/README.md) |
