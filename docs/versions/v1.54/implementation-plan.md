...
- [x] 完成合并后全量检查、生产打包、本机 Applications 安装、备份清理与 PR CI。
...
- [x] `pnpm docs:test`、`pnpm docs:check`、`DOCS_BASE_REF=<merge-base> pnpm docs:check:ci`、`git diff --check`；
...
| 文档与交互稿 | `passed` | docs 单测 9 项、版本与决定治理、HTML inline script parse、diff hygiene、diff-aware 门禁与 PR CI 通过 |
...
- Base：`2ffc49eaebaf625c04c7dfc44ac74856c11cb88e`
- Status：`complete`
