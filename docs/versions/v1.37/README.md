...
- 钉钉渠道页入口已恢复，普通群项目卡增加 Quick Chat；执行中卡改为“显示最近输出 / 打开执行台 / 停止执行”，
  ...
  [V1.37-D09](decisions.md#v1-37-d09)、[V1.37-D10](decisions.md#v1-37-d10)、[V1.37-D11](decisions.md#v1-37-d11)与
  [V1.37-D12](decisions.md#v1-37-d12)。
- Applications 真实内部群验收推翻了 `chatbotUserId === atUsers[].dingtalkId` 的合成 fixture 假设：钉钉普通群现在以
  ...
  判断，多 Rovai App 实际接收仍 fail closed，私聊继续直接 Quick Chat。飞书和钉钉新 Bot 首次发布 completed 后向
