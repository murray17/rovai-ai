...
- [x] 在 v0.75 完成并推送后，从同一 `origin/main` 基线开启唯一 current v0.76；
- [x] 接受 ADR-0184，冻结 durable reply intent、Draft-only user send 与无 Default Lead fallback；
...
- [ ] 回填证据、冻结未完成项并发布后，才把 v0.76 标记为 complete。

## 当前证据与缺口

- 已完成：版本隔离、v0.75 基线确认、三方向 HTML 交互稿与方案 C 选择、ADR-0184、Camp Composer Draft v1、
