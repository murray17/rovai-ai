...
# Rovai-ai v1.33：Camp 队员 Fast 覆盖

在成员浮层中保存当前 Camp、当前成员、当前 Runtime 绑定的 Fast / Standard / 继承选择；每次新执行
冻结并发送原生覆盖。已有 Run、全局配置和 Native Thread 默认不改变。

前置版本：[v1.32](../v1.32/README.md)。[实施计划](implementation-plan.md)；[决定理由](decisions.md)。
...
| 范围 | 结论 | 证据或理由 |
| --- | --- | --- |
| Version lifecycle | 已更新 | 本概览、[实施计划](implementation-plan.md)、[版本索引](../README.md)，v1.32 lifecycle 冻结 |
| Decisions | 已更新 | [V1.33-D01](decisions.md#v1-33-d01)、[当前决定导航](../../decisions/CURRENT.md) |
