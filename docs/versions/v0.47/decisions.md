...
| 历史 ID | 决策 | 迁移时状态 |
| --- | --- | --- |
| [ADR-0136](#adr-0136) | Durable Task v2 Responsibility and Coordination Authority | `accepted` |
| [ADR-0137](#adr-0137) | One-Time Task-Linked Responsibility Admission | `accepted` |

<!-- legacy-adr:begin id=ADR-0136 source-file-sha256=ba2ee148f6869605dea90d5cf4ab647f31e7045b94349cfd57d5ab1e2c4a415c -->
<a id="adr-0136"></a>

## ADR-0136: Durable Task v2 Responsibility and Coordination Authority

迁移时原路径：`docs/adr/0136-durable-task-v2-responsibility-and-coordination-authority.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<!-- legacy-adr-body:begin id=ADR-0136 -->
<a id="adr-0136-context"></a>
### Context
...
<a id="adr-0136-decision"></a>
### Decision

<a id="adr-0136-1-keep-responsibility-notification-and-execution-separate"></a>
...
<a id="adr-0136-2-adopt-the-five-state-durable-task-v2-lifecycle"></a>
...
<a id="adr-0136-3-make-task-coordination-authority-explicit"></a>
...
<a id="adr-0136-4-separate-current-membership-from-execution-eligibility"></a>
...
<a id="adr-0136-5-make-permanent-removal-a-managed-atomic-cascade"></a>
...
<a id="adr-0136-6-locally-replace-earlier-task-clauses"></a>
...
<a id="adr-0136-rejected-alternatives"></a>
...
<a id="adr-0136-references"></a>
### References

- [v0.47 version overview](README.md)
...
<!-- legacy-adr-body:end id=ADR-0136 -->
<!-- legacy-adr:end id=ADR-0136 -->

<!-- legacy-adr:begin id=ADR-0137 source-file-sha256=708205c3a8858dc9b7e5b70f9921590f2a3f6f6b17f9febbb5fd40fc0eeb6582 -->
<a id="adr-0137"></a>

## ADR-0137: One-Time Task-Linked Responsibility Admission

迁移时原路径：`docs/adr/0137-one-time-task-linked-responsibility-admission.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<!-- legacy-adr-body:begin id=ADR-0137 -->
<a id="adr-0137-context"></a>
### Context
...
<a id="adr-0137-decision"></a>
### Decision

<a id="adr-0137-1-admit-task-linkage-exactly-once"></a>
...
<a id="adr-0137-2-grandfather-every-accepted-responsibility-against-later-task-changes"></a>
...
<a id="adr-0137-3-keep-independent-execution-admission-current"></a>
...
<a id="adr-0137-4-locally-replace-continuous-task-execution-checks"></a>
...
<a id="adr-0137-rejected-alternatives"></a>
### Rejected Alternatives
...
- [ADR-0131: Recipient-Scoped Event-Driven Delivery Recovery](../v0.45/decisions.md#adr-0131)
- [Rovai-ai domain language](../../../CONTEXT.md)
<!-- legacy-adr-body:end id=ADR-0137 -->
<!-- legacy-adr:end id=ADR-0137 -->
