...
| 历史 ID | 决策 | 迁移时状态 |
| --- | --- | --- |
| [ADR-0135](#adr-0135) | Compact Agent Output over Canonical Built-in Tool Envelope | `accepted` |

<!-- legacy-adr:begin id=ADR-0135 source-file-sha256=724439e2cf98975f1c1445b0e7c2d421b88fd602b358e062cf3a1d75f5ead443 -->
<a id="adr-0135"></a>

## ADR-0135: Compact Agent Output over Canonical Built-in Tool Envelope

迁移时原路径：`docs/adr/0135-compact-agent-output-over-canonical-built-in-tool-envelope.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<!-- legacy-adr-body:begin id=ADR-0135 -->
<a id="adr-0135-context"></a>
### Context
...
<a id="adr-0135-decision"></a>
### Decision

<a id="adr-0135-1-keep-one-complete-core-envelope"></a>
...
<a id="adr-0135-2-project-only-after-validation"></a>
...
<a id="adr-0135-3-define-the-agent-result-contract-by-operation"></a>
...
<a id="adr-0135-4-keep-discovery-inside-core"></a>
...
<a id="adr-0135-5-make-output-mode-host-owned"></a>
...
<a id="adr-0135-6-publish-safe-error-channels"></a>
...
<a id="adr-0135-7-locally-replace-adr-0124s-agent-facing-clauses"></a>
...
<a id="adr-0135-rejected-alternatives"></a>
...
<a id="adr-0135-references"></a>
### References

- [v0.46 version overview](README.md)
- [v0.46 implementation plan](implementation-plan.md)
...
- [ADR-0118: Local Data Clean Break and Managed Reset Boundary](../v0.41/decisions.md#adr-0118)
- [Rovai-ai domain language](../../../CONTEXT.md)
<!-- legacy-adr-body:end id=ADR-0135 -->
<!-- legacy-adr:end id=ADR-0135 -->
