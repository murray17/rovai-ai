...
| 历史 ID | 决策 | 迁移时状态 |
| --- | --- | --- |
| [ADR-0096](#adr-0096) | Core-Owned Structured Mentions and Mention-Derived Camp Addressing | `superseded` |

<!-- legacy-adr:begin id=ADR-0096 source-file-sha256=19cd545984dc94760fc7e56f90fa045f39f28ba6e425bd84185e5affcae72562 -->
<a id="adr-0096"></a>

## ADR-0096: Core-Owned Structured Mentions and Mention-Derived Camp Addressing

迁移时原路径：`docs/adr/0096-core-owned-structured-mentions-and-derived-addressing.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<!-- legacy-adr-body:begin id=ADR-0096 -->
<a id="adr-0096-context"></a>
### Context
...
<a id="adr-0096-decision"></a>
### Decision

<a id="adr-0096-1-closed-structured-content-is-the-semantic-authority"></a>
...
<a id="adr-0096-2-mentions-are-atomic-identity-occurrences"></a>
...
<a id="adr-0096-3-exact-draft-revision-is-the-user-send-boundary"></a>
...
<a id="adr-0096-4-identity-projection-and-run-freezing"></a>
...
<a id="adr-0096-5-clipboard-and-legacy-compatibility"></a>
...
<a id="adr-0096-rejected-alternatives"></a>
...
- [ADR-0060: Opaque Member Routing Identity](../v0.16/decisions.md#adr-0060)
...
- [结构化 Mention UI 合同](../../ui/components/structured-mentions.md#不得回退的交互合同)
...
<!-- legacy-adr-body:end id=ADR-0096 -->
<!-- legacy-adr:end id=ADR-0096 -->
