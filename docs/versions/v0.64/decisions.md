...
| 历史 ID | 决策 | 迁移时状态 |
| --- | --- | --- |
| [ADR-0164](#adr-0164) | Accepted Input Recovery Requires Proven Native Turn Reconciliation | `accepted` |

<!-- legacy-adr:begin id=ADR-0164 source-file-sha256=b648742fa298ab9f57538031a11dcea8269ba58b69fd3ac59852b8c40000ebe1 -->
<a id="adr-0164"></a>

## ADR-0164: Accepted Input Recovery Requires Proven Native Turn Reconciliation

迁移时原路径：`docs/adr/0164-accepted-input-recovery-requires-proven-native-turn-reconciliation.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<!-- legacy-adr-body:begin id=ADR-0164 -->
<a id="adr-0164-context"></a>
### Context
...
<a id="adr-0164-rejected-alternatives"></a>
...
<a id="adr-0164-references"></a>
### References

- [v0.64 版本目标](README.md)
- [ADR-0062：Interruptible Runs](../v0.17/decisions.md#adr-0062)
- [ADR-0067：Native Session Bootstrap 与 AgentRun Context](../v0.21/decisions.md#adr-0067)
...
- [Copilot Native Turn P1 实验与负向证据](copilot-native-turn-reconciliation-experiment.md)
<!-- legacy-adr-body:end id=ADR-0164 -->
<!-- legacy-adr:end id=ADR-0164 -->
