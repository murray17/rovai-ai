...
| 历史 ID | 决策 | 迁移时状态 |
| --- | --- | --- |
| [ADR-0151](#adr-0151) | Versioned Benchmark Protocol and Axis-Scoped Comparability | `accepted` |

<!-- legacy-adr:begin id=ADR-0151 source-file-sha256=543fd4439355572e8acd040c4601799ffb2413dbde1026dfd72790dd723a1e14 -->
<a id="adr-0151"></a>

## ADR-0151: Versioned Benchmark Protocol and Axis-Scoped Comparability

迁移时原路径：`docs/adr/0151-versioned-benchmark-protocol-and-axis-comparability.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<!-- legacy-adr-body:begin id=ADR-0151 -->
<a id="adr-0151-context"></a>
### Context
...
<a id="adr-0151-rejected-alternatives"></a>
...
<a id="adr-0151-references"></a>
### References

- [v0.53 overview](README.md)
...
- [ADR-0102](../v0.36/decisions.md#adr-0102)
<!-- legacy-adr-body:end id=ADR-0151 -->
<!-- legacy-adr:end id=ADR-0151 -->
