...
| 历史 ID | 决策 | 迁移时状态 |
| --- | --- | --- |
| [ADR-0200](#adr-0200) | Compact AgentRun Context Projection and Structured Run Facts | `accepted` |

<!-- legacy-adr:begin id=ADR-0200 source-file-sha256=78ad937c15d2bc557461f8a0dbb2559c1563164ce927a87280013948b04822f6 -->
<a id="adr-0200"></a>

## ADR-0200: Compact AgentRun Context Projection and Structured Run Facts

迁移时原路径：`docs/adr/0200-compact-context-projection-and-structured-run-facts.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<!-- legacy-adr-body:begin id=ADR-0200 -->
<a id="adr-0200-context"></a>
### Context
...
<a id="adr-0200-decision"></a>
### Decision

<a id="adr-0200-charter-remains-stable-authority-not-command-documentation"></a>
...
<a id="adr-0200-shared-conversation-uses-one-camp-and-compact-message-continuation"></a>
...
<a id="adr-0200-run-facts-replace-run-notices"></a>
...
<a id="adr-0200-version-and-clean-break-boundary"></a>
...
<a id="adr-0200-rejected-alternatives"></a>
...
<a id="adr-0200-references"></a>
### References

- [v0.94 model-context change statement](model-context-change.md)
...
- [ADR-0149](../v0.52/decisions.md#adr-0149)
- [ADR-0195](../v0.90/decisions.md#adr-0195)
- [ADR-0196](../v0.90/decisions.md#adr-0196)
<!-- legacy-adr-body:end id=ADR-0200 -->
<!-- legacy-adr:end id=ADR-0200 -->
