...
| 历史 ID | 决策 | 迁移时状态 |
| --- | --- | --- |
| [ADR-0008](#adr-0008) | Collaboration v2: Camp-Centered Navigation and Lifecycle | `superseded` |

<!-- legacy-adr:begin id=ADR-0008 source-file-sha256=1cdc9ef19b9cdb71d9cf229e9257772d534a8e62a121ce42471537b5514c64e4 -->
<a id="adr-0008"></a>

## ADR-0008: Collaboration v2: Camp-Centered Navigation and Lifecycle

迁移时原路径：`docs/adr/0008-collaboration-v2.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<!-- legacy-adr-body:begin id=ADR-0008 -->
<a id="adr-0008-context"></a>
### Context
...
<a id="adr-0008-decision"></a>
### Decision

<a id="adr-0008-collaboration-aggregate"></a>
...
<a id="adr-0008-project-projection-and-repository-binding"></a>
...
<a id="adr-0008-creation-members-and-routing"></a>
...
<a id="adr-0008-messages-context-and-execution"></a>
...
<a id="adr-0008-permanent-deletion"></a>
#### Permanent deletion
...
<a id="adr-0008-required-constraints"></a>
...
<a id="adr-0008-rejected-alternatives"></a>
...
<a id="adr-0008-references"></a>
### References

- [v0.04 主工作区导航](README.md)
- [ADR-0001 Core Transaction](../v0.02/decisions.md#adr-0001)
- [ADR-0003 Execution Runtime](../v0.02/decisions.md#adr-0003)
- [ADR-0005 Evidence & Read Side](../v0.02/decisions.md#adr-0005)
- [Superseded ADR-0002 Collaboration](../v0.02/decisions.md#adr-0002)
<!-- legacy-adr-body:end id=ADR-0008 -->
<!-- legacy-adr:end id=ADR-0008 -->
