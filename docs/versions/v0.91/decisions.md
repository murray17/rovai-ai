...
| 历史 ID | 决策 | 迁移时状态 |
| --- | --- | --- |
| [ADR-0197](#adr-0197) | Empty User-Owned MCP Library Without Product Presets | `accepted` |

<!-- legacy-adr:begin id=ADR-0197 source-file-sha256=07d1b03022e3a316c8b5857be16c5f821f62f315c4c87b5efc9c3ad205c06c55 -->
<a id="adr-0197"></a>

## ADR-0197: Empty User-Owned MCP Library Without Product Presets

迁移时原路径：`docs/adr/0197-empty-user-owned-mcp-library.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<!-- legacy-adr-body:begin id=ADR-0197 -->
<a id="adr-0197-context"></a>
### Context
...
<a id="adr-0197-rejected-alternatives"></a>
...
<a id="adr-0197-references"></a>
### References

- [v0.91 Empty MCP Library](README.md)
...
- [ADR-0125: Runtime-Native Additive External MCP Projection](../v0.43/decisions.md#adr-0125)
<!-- legacy-adr-body:end id=ADR-0197 -->
<!-- legacy-adr:end id=ADR-0197 -->
