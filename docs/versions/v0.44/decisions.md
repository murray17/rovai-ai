...
| 历史 ID | 决策 | 迁移时状态 |
| --- | --- | --- |
| [ADR-0129](#adr-0129) | Deterministic Bounded Raw Public Context Delivery | `accepted` |

<!-- legacy-adr:begin id=ADR-0129 source-file-sha256=7a8b899b67e51812a355385ef6ac62580a100694744413031414a9a98cb58af1 -->
<a id="adr-0129"></a>

## ADR-0129: Deterministic Bounded Raw Public Context Delivery

迁移时原路径：`docs/adr/0129-deterministic-bounded-raw-public-context-delivery.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<!-- legacy-adr-body:begin id=ADR-0129 -->
<a id="adr-0129-context"></a>
### Context
...
<a id="adr-0129-decision"></a>
### Decision

<a id="adr-0129-accepted-public-context-boundary"></a>
...
<a id="adr-0129-current-input-remains-complete"></a>
...
<a id="adr-0129-originating-public-user-message-for-member-calls"></a>
...
<a id="adr-0129-bounded-raw-public-messages"></a>
...
<a id="adr-0129-unicode-scalar-body-prefix-and-history-budget"></a>
...
<a id="adr-0129-explicit-omission-notice"></a>
...
<a id="adr-0129-stable-collaboration-state"></a>
...
<a id="adr-0129-versioned-context-delivery-profile"></a>
...
<a id="adr-0129-contextmanifest-recovery-and-clean-break"></a>
...
<a id="adr-0129-summary-system-and-advanced-settings-are-removed"></a>
...
<a id="adr-0129-replacement-scope"></a>
#### Replacement scope
...
<a id="adr-0129-rejected-alternatives"></a>
...
<a id="adr-0129-references"></a>
### References

- [v0.44 AgentRun 确定性原始公共上下文](README.md)
...
- [ADR-0081: Camp-Public Attachment Paths and Frozen Discovery](../v0.25/decisions.md#adr-0081)
- [ADR-0099: Independent Member Calls](../v0.34/decisions.md#adr-0099)
- [ADR-0106: Agent-Bounded Cross-Camp Public History Retrieval](../v0.40/decisions.md#adr-0106)
- [ADR-0108: Discovery-Only Camp Message Search](../v0.40/decisions.md#adr-0108)
<!-- legacy-adr-body:end id=ADR-0129 -->
<!-- legacy-adr:end id=ADR-0129 -->
