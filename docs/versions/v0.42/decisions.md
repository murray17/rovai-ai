...
| 历史 ID | 决策 | 迁移时状态 |
| --- | --- | --- |
| [ADR-0124](#adr-0124) | CLI-Only Transport for Rovai Built-in Operations | `accepted` |

<!-- legacy-adr:begin id=ADR-0124 source-file-sha256=80be4a369265b76f409f79da19b340e60e4dba1073aa20bbf204e845f0db3fdc -->
<a id="adr-0124"></a>

## ADR-0124: CLI-Only Transport for Rovai Built-in Operations

迁移时原路径：`docs/adr/0124-cli-only-transport-for-rovai-built-in-operations.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<!-- legacy-adr-body:begin id=ADR-0124 -->
<a id="adr-0124-context"></a>
### Context
...
<a id="adr-0124-decision"></a>
### Decision

<a id="adr-0124-cli-是唯一内置工具运输"></a>
#### CLI 是唯一内置工具运输
...
<a id="adr-0124-cli-使用领域分组命令canonical-operation-不改名"></a>
...
<a id="adr-0124-bootstrap-只承载稳定-cli-合同"></a>
...
<a id="adr-0124-同一命令支持直接参数stdinheredoc-和输入文件"></a>
...
<a id="adr-0124-内置-mcp-是-clean-break不是兼容模式"></a>
...
<a id="adr-0124-九个-runtime-共同构成发布门禁"></a>
#### 九个 Runtime 共同构成发布门禁
...
<a id="adr-0124-失败必须给出安全明确的处理规则"></a>
#### 失败必须给出安全、明确的处理规则
...
<a id="adr-0124-当前-run-权限不能来自可复用进程身份"></a>
...
<a id="adr-0124-shell-子进程共享当前-run-的调用身份"></a>
...
<a id="adr-0124-cli-shell-只作为可验证的运输证据"></a>
...
<a id="adr-0124-rejected-alternatives"></a>
...
- [ADR-0104: Rovai-Preferred MCP Projection and Non-Blocking External Degradation](../v0.37/decisions.md#adr-0104)
- [ADR-0113: Core-Scoped Operation Identity and Evidence Deduplication Boundary](../v0.41/decisions.md#adr-0113)
- [ADR-0123: Exclusive AgentRun Runtime Processes and Resident Fleet Reuse](../v0.41/decisions.md#adr-0123)
<!-- legacy-adr-body:end id=ADR-0124 -->
<!-- legacy-adr:end id=ADR-0124 -->
