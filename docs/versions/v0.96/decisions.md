...
| 历史 ID | 决策 | 迁移时状态 |
| --- | --- | --- |
| [ADR-0201](#adr-0201) | Sparse Runtime Usage Authority and Clean-Break Monitoring Enrollment | `superseded` |

<!-- legacy-adr:begin id=ADR-0201 source-file-sha256=38435d3e40ac531c2bcdd4cf6d5790c612887a0591a01239cb6bc312e277486d -->
<a id="adr-0201"></a>

## ADR-0201: Sparse Runtime Usage Authority and Clean-Break Monitoring Enrollment

迁移时原路径：`docs/adr/0201-sparse-runtime-usage-and-clean-break-monitoring.md`。以下 Front Matter 与正文来自迁移基线；状态表示迁移时的记录状态，不代表该决定在来源版本冻结时的状态。
...
<!-- legacy-adr-body:begin id=ADR-0201 -->
<a id="adr-0201-context"></a>
### Context
...
<a id="adr-0201-decision"></a>
### Decision

<a id="adr-0201-runtime-usage-is-a-separate-sparse-authority"></a>
...
<a id="adr-0201-monitoring-uses-explicit-clean-break-enrollment"></a>
...
<a id="adr-0201-session-tool-and-cost-truth-retain-their-own-grains"></a>
...
<a id="adr-0201-rejected-alternatives"></a>
...
<a id="adr-0201-references"></a>
### References

- [v0.96 运行监控与原生 Usage 观测](README.md)
...
- [ADR-0117](../v0.41/decisions.md#adr-0117)
- [ADR-0148](../v0.51/decisions.md#adr-0148)
<!-- legacy-adr-body:end id=ADR-0201 -->
<!-- legacy-adr:end id=ADR-0201 -->
