...
<a id="v1-30-d01"></a>
## V1.30-D01：Pi 使用独立 JSONL RPC、受管 Approval 与 exact Session binding
...
<a id="v1-30-d02"></a>
## V1.30-D02：Pi resident Host 使用原生状态与逐 Run managed model input
...
7. Grok 已占用 Migration 107/108，主线 Runtime entrypoint locator identity 已占用 Migration 109，Camp 动态
   成员已占用 Migration 110 并升至 `v1.23 / schema 64`。Pi catalog 使用 Migration 111 升至
   `v1.24 / schema 65`，managed context 使用 Migration 112 升至 `v1.25 / schema 66`；112 fence
   缺少 frozen identity/managed receipt 的旧
...
<a id="v1-30-d03"></a>
## V1.30-D03：新版 First-Class Checklist 下 Pi 暂按 Core Compatible 管理
