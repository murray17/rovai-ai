...
# v1.30 Pi resident Runtime revision 1 实施验收计划
...
- [x] 保留主线 Runtime entrypoint locator identity Migration 109 与 Camp 动态成员 Migration 110，在其后新增
  Pi Migration 111/112，最终 Data Contract 升级为 `v1.25 / schema 66 / migration 112`；
...
- [x] Migration 110 从主线 v1.22/schema 63/migration 109 增加 Camp 动态成员并升级为 v1.23/schema 64；
- [x] Migration 111 从 v1.23/schema 64 增加 Pi catalog 与 Skill group，升级为 v1.24/schema 65；
- [x] Migration 112 从 v1.24/schema 65 增加 Evidence v2/receipt table/acceptance trigger，升级为
  v1.25/schema 66；
...
- [x] 旧 migration synthetic fixture 已适配 schema 66 约束，并保留 Grok 107/108、主线 locator 109、Camp
  membership 110 与 Pi 111/112 逐版本验证。

## 9. 自动化与收尾

- [x] Pi adapter capability、workspace Fleet LRU、Bootstrap Evidence/receipt、Migration 111/112 与 MCP bridge 定向
  tests 通过；
