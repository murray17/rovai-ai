...
| 配置和验收钉钉 Web Session 渠道 | [本地开发与 App 隔离流程：钉钉 Web Session](local-workflow.md#钉钉-web-session-验收前置)、[DingTalk Channel v8](../contracts/dingtalk-channel-v8.md)、[Channel Storage v3](../contracts/channel-storage-v3.md) |
