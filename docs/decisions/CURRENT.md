...
- Runtime 图片当前规范：[Runtime 图片架构](../architecture/runtime-images.md)、[Runtime Images v3](../contracts/runtime-images-v3.md)、[统一图片展示](../ui/components/conversation-workspace.md#runtime-图片与消息图片)；混合生命周期与不自动发布的理由：[V1.37-D01](../versions/v1.37/decisions.md#v1-37-d01)。
...
- 当前 Pi 独立 JSONL optional subsystem 与逐平台未准入理由：[V1.39-D01](../versions/v1.39/decisions.md#v1-39-d01)；串行多 Session Resident Host、exact resume 与 locator 隐私理由：[V1.39-D02](../versions/v1.39/decisions.md#v1-39-d02)。
...
- Pi `.pi/skills` 动态 discovery 与 Core-owned MCP bridge 的理由：[V1.39-D04](../versions/v1.39/decisions.md#v1-39-d04)。
...
- Pi terminal assistant model-call Usage 与 Action lifecycle 的当前字段边界由 [Runtime Launch v30](../contracts/runtime-launch-and-verification-v30.md)拥有，接入理由见 [V1.39-D01](../versions/v1.39/decisions.md#v1-39-d01)。
