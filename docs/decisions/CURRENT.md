...
- 当前 Pi 独立 JSONL optional subsystem 与资格分离理由：[V1.39-D01](../versions/v1.39/decisions.md#v1-39-d01)；串行多 Session Resident Host、exact resume 与 locator 隐私理由：[V1.39-D02](../versions/v1.39/decisions.md#v1-39-d02)；三平台可运行 Preview 与非 Qualified disclosure 理由：[V1.39-D06](../versions/v1.39/decisions.md#v1-39-d06)；Runtime portable child command 与 Pi 外部 MCP 逐 Server 降级理由：[V1.39-D07](../versions/v1.39/decisions.md#v1-39-d07)；ACP derived child 最终上下文解析与 Pi MCP 有界并发激活理由：[V1.39-D08](../versions/v1.39/decisions.md#v1-39-d08)。
...
- Pi managed system prompt、原子 receipt 与 `native_system_prompt_preserved` 理由：[V1.39-D03](../versions/v1.39/decisions.md#v1-39-d03)及已确认的[模型上下文 revision 1](../versions/v1.39/model-context-change-pi-managed-system-prompt.md)。
...
- Pi terminal assistant model-call Usage 与 Action lifecycle 的当前字段边界由 [Runtime Launch v31](../contracts/runtime-launch-and-verification-v31.md)继承 v30，接入理由见 [V1.39-D01](../versions/v1.39/decisions.md#v1-39-d01)。
