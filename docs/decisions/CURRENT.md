...
- Pi managed system prompt、原子 receipt 与 `native_system_prompt_preserved` 理由：[V1.39-D03](../versions/v1.39/decisions.md#v1-39-d03)及已确认的[模型上下文 revision 2](../versions/v1.39/model-context-change-pi-managed-system-prompt.md)。
...
- Pi `.pi/skills` 动态 discovery 理由：[V1.39-D04](../versions/v1.39/decisions.md#v1-39-d04)；当前 Pi External MCP Unsupported 与旧 bridge clean removal 理由：[V1.39-D09](../versions/v1.39/decisions.md#v1-39-d09)。
...
- Pi terminal assistant model-call Usage 与 Action lifecycle 的当前字段边界由 [Runtime Launch v32](../contracts/runtime-launch-and-verification-v32.md)继承 v31，接入理由见 [V1.39-D01](../versions/v1.39/decisions.md#v1-39-d01)。
