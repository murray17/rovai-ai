...
- 当前规范：[双轨执行评测](../architecture/execution-evaluation.md)、[Execution Evaluation v5](../contracts/execution-evaluation-v5.md)、[User Automation v4](../contracts/user-automation-v4.md)与[操作指南](../development/evaluation.md)。
