...
- Pi `.pi/skills` 动态 discovery 与 Core-owned MCP bridge 的理由：[V1.39-D04](../versions/v1.39/decisions.md#v1-39-d04)；portable MCP command 与逐 Server optional activation 的理由：[V1.39-D07](../versions/v1.39/decisions.md#v1-39-d07)。
