...
- 当前规范：[Cancellation Settlement v1](../contracts/cancellation-settlement-v1.md)、[Accepted Input Recovery v4](../contracts/accepted-input-recovery-v4.md)、[Camp Membership v2](../contracts/camp-membership-v2.md)、[Channel Storage v3](../contracts/channel-storage-v3.md)和[Runtime 恢复与关闭](../architecture/foundational-invariants.md#runtime-recovery-shutdown)。
