...
- 当前规范：[File Preview Architecture](../architecture/file-preview.md)、[File Preview v7](../contracts/file-preview-v7.md)、[Camp 文件预览区](../ui/components/file-preview.md)及[Camp 会话工作区](../ui/components/conversation-workspace.md)。
