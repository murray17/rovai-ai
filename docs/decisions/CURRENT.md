...
- 当前规范：[Pending Camp Input v1](../contracts/pending-camp-input-v1.md)、[Camp Composer Draft v6](../contracts/camp-composer-draft-v6.md)、[Composer 架构](../architecture/camp-composer-draft.md)。
- 私有准入、单编辑占用和显式恢复的理由：[V1.33-D01](../versions/v1.33/decisions.md#v1-33-d01)。
