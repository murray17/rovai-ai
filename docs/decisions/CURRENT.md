...
- 当前规范：[Single Chat Architecture](../architecture/single-chat.md)、[Single Chat v3](../contracts/single-chat-v3.md)、[AgentRun Recovery](../architecture/agent-run-recovery.md)和[Camp 内单聊 UI](../ui/components/conversation-workspace.md#camp-内单聊)。
...
- 当前规范：[Skill/MCP 基础不变量](../architecture/foundational-invariants.md#skills-builtin-transport)、[Built-in Tool Runtime](../architecture/builtin-tool-runtime.md)、[Skill Projection](../architecture/skill-projection-reconciliation.md)、[Built-in Tool Transport v23](../contracts/builtin-tool-transport-v23.md)、[Windows Skill Projection v1](../contracts/windows-skill-projection-v1.md)、[Skill Content Preview v1](../contracts/skill-content-preview-v1.md)和[Capability settings](../ui/components/capability-settings.md)。
...
- 当前规范：[Scheduled Automation 不变量](../architecture/foundational-invariants.md#scheduled-automation)、[Scheduled Automation Architecture](../architecture/scheduled-automation.md)、[Scheduled Automation v1](../contracts/scheduled-automation-v1.md)、[Automation 工作区](../ui/components/automation-workspace.md)和[Built-in Tool Transport v23](../contracts/builtin-tool-transport-v23.md)。
...
- Pi terminal assistant model-call Usage、原生 Action lifecycle 与 `agent_start` admission 的当前字段边界由 [Runtime Launch v36](../contracts/runtime-launch-and-verification-v36.md)继承并收敛，接入理由见 [V1.39-D01](../versions/v1.39/decisions.md#v1-39-d01)和[V1.48-D01](../versions/v1.48/decisions.md#v1-48-d01)。
...
- 当前规范：[Camp Attachment v8](../contracts/camp-attachment-v8.md)、[Camp Message Send v19](../contracts/camp-message-send-v19.md)、[Built-in Tool Transport v23](../contracts/builtin-tool-transport-v23.md)及[附件架构](../architecture/camp-published-attachment-view.md)。Agent CLI 的私有 snapshot 语义继续由 v8 继承的 v7 条款拥有。
- 主要理由：[V1.32-D01](../versions/v1.32/decisions.md#v1-32-d01)：由 CLI 以 Runtime 权限适配外部路径，保持 Core 的读取根目录限制。

## Camp 连续消息

- 当前规范：[Pending Camp Input v3](../contracts/pending-camp-input-v3.md)、[Camp Composer Draft v12](../contracts/camp-composer-draft-v12.md)、[Composer 架构](../architecture/camp-composer-draft.md)。
