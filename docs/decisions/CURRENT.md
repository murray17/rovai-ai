...
- 当前规范：[Channel Storage v3](../contracts/channel-storage-v3.md)、[飞书渠道架构](../architecture/feishu-channel.md)、[Feishu Channel v15](../contracts/feishu-channel-v15.md)、[钉钉渠道架构](../architecture/dingtalk-channel.md)、[DingTalk Channel v10](../contracts/dingtalk-channel-v10.md)、[Camp Membership v2](../contracts/camp-membership-v2.md)、[ContextManifest Evidence v22](../contracts/context-manifest-evidence-v22.md)和[渠道设置](../ui/components/channel-settings.md)。
