...
- 当前规范：[Channel Storage v2](../contracts/channel-storage-v2.md)、[飞书渠道架构](../architecture/feishu-channel.md)、[Feishu Channel v2](../contracts/feishu-channel-v2.md)、[钉钉渠道架构](../architecture/dingtalk-channel.md)、[DingTalk Channel v3](../contracts/dingtalk-channel-v3.md)、[Camp Membership v1](../contracts/camp-membership-v1.md)、[ContextManifest Evidence v22](../contracts/context-manifest-evidence-v22.md)和[渠道设置](../ui/components/channel-settings.md)。
