...
- 当前 Pi 独立 JSONL RPC、Claude 本机 MiniMax provider、受管 Approval、warm/exact continuation 与保守能力边界的理由：[V1.28-D01](../versions/v1.28/decisions.md#v1-28-d01)。
