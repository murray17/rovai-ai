...
- 内部调度合同：[Channel Host Maintenance v4](../contracts/channel-host-maintenance-v4.md)；Core 领域表拥有 outstanding 真源，Main 使用事件快路径与仅在有工作时存在的十分钟恢复 watchdog，真实业务命令与 Outbox 恢复不变。选择理由见 [V1.37-D06](../versions/v1.37/decisions.md#v1-37-d06)。
