...
- Pi managed system prompt、最小原子 receipt 与 `native_system_prompt_preserved` 理由：[V1.39-D03](../versions/v1.39/decisions.md#v1-39-d03)、[V1.39-D10](../versions/v1.39/decisions.md#v1-39-d10)及已确认的[模型上下文 revision 3](../versions/v1.39/model-context-change-pi-managed-system-prompt.md)。
...
- Pi `.pi/skills` 追加 discovery 与原生 Skill 共存理由：[V1.39-D10](../versions/v1.39/decisions.md#v1-39-d10)；当前 Pi External MCP Unsupported 与旧 bridge clean removal 理由：[V1.39-D09](../versions/v1.39/decisions.md#v1-39-d09)。
...
- Pi terminal assistant model-call Usage 与 Action lifecycle 的当前字段边界由 [Runtime Launch v33](../contracts/runtime-launch-and-verification-v33.md)继承 v32/v31，接入理由见 [V1.39-D01](../versions/v1.39/decisions.md#v1-39-d01)。
