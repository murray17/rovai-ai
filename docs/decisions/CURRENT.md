...
- 当前规范：[Camp Attachment v8](../contracts/camp-attachment-v8.md)、[Camp Message Send v19](../contracts/camp-message-send-v19.md)、[Built-in Tool Transport v24](../contracts/builtin-tool-transport-v24.md)及[附件架构](../architecture/camp-published-attachment-view.md)。Agent CLI 的私有 snapshot 语义继续由 v8 继承的 v7 条款拥有。
...
- 当前规范：[双轨执行评测](../architecture/execution-evaluation.md)、[Execution Evaluation v6](../contracts/execution-evaluation-v6.md)、[User Automation v4](../contracts/user-automation-v4.md)与[操作指南](../development/evaluation.md)。
