...
- 当前规范：[Single Chat Architecture](../architecture/single-chat.md)、[Single Chat v4](../contracts/single-chat-v4.md)、[AgentRun Recovery](../architecture/agent-run-recovery.md)和[Camp 内单聊 UI](../ui/components/conversation-workspace.md#camp-内单聊)。
