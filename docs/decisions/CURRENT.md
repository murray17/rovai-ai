...
- 当前 Pi 独立 JSONL RPC、安全 Approval 与 exact Session 初始边界理由：[V1.29-D01](../versions/v1.29/decisions.md#v1-29-d01)；resident multi-session、managed Bootstrap、动态 Skills 与 Core-managed stdio MCP 理由：[V1.29-D02](../versions/v1.29/decisions.md#v1-29-d02)；新版 First-Class Checklist 下暂按 Core Compatible 管理的理由：[V1.29-D03](../versions/v1.29/decisions.md#v1-29-d03)。
