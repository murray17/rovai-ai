...
- Runtime 图片当前规范：[Runtime 图片架构](../architecture/runtime-images.md)、[Runtime Images v2](../contracts/runtime-images-v2.md)、[统一图片展示](../ui/components/conversation-workspace.md#runtime-图片与消息图片)；混合生命周期与不自动发布的理由：[V1.37-D01](../versions/v1.37/decisions.md#v1-37-d01)。
