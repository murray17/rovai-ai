...
- 当前 Pi 独立 JSONL RPC 与受管 Approval 的初始理由：[V1.28-D01](../versions/v1.28/decisions.md#v1-28-d01)；原生认证、workspace resident Host、动态 Bootstrap/Skills/MCP、managed receipt 与 exact Session 切换的修正理由：[V1.28-D02](../versions/v1.28/decisions.md#v1-28-d02)。
