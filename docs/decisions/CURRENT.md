...
- 当前 Pi 独立 JSONL optional subsystem 与资格分离理由：[V1.39-D01](../versions/v1.39/decisions.md#v1-39-d01)；串行多 Session Resident Host、exact resume 与 locator 隐私理由：[V1.39-D02](../versions/v1.39/decisions.md#v1-39-d02)；三平台可运行 Preview 与非 Qualified disclosure 理由：[V1.39-D06](../versions/v1.39/decisions.md#v1-39-d06)。
