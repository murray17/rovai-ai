...
完整继承 [v5](file-preview-v5.md) 的 owner-scoped Attachment 动作，以及 [v3](file-preview-v3.md) 的来源校验、
具体文件能力、Preview／系统打开分类、窗口句柄、读取、刷新、系统操作、更新通知和资源释放边界；替代
[v4](file-preview-v4.md) 的消息渲染前文件存在性探测。
...
本版本不修改 classifier、owner-scoped Attachment、目录处理、外部具体文件、Root Grant 或系统打开边界。图标与
打开结果彼此不能互相推断。
