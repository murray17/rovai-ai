...
| [Runtime Launch and Verification v26（当前）](runtime-launch-and-verification-v26.md) | v25 launch/权限/Cursor 边界不变；增加 TRAE 专属 `rawInput.Command` 公开白名单，修正 ACP error/activity 输入确认与全 Runtime 安全 failure，并分离 AgentRun 审计 wall clock 与 Execution Budget observation |
