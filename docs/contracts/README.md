...
| [Runtime Launch and Verification v18（当前）](runtime-launch-and-verification-v18.md) | v17 wire/LKG 边界不变；Adapter Deep Probe 统一覆盖 version、一次重新绑定与三秒 Execution cooldown 自动恢复 |
