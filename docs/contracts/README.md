...
| [Semantic Judge Views v5（当前）](semantic-judge-views-v5.md) | 指标证据合同与同 View 一次分歧裁决；历史双副本保留 |
...
| [Execution Evaluation v7（当前）](execution-evaluation-v7.md) | 评分 2.3、Suite 2.5、可验证指标及历史证据重评边界 |
