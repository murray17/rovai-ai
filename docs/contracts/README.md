...
| [Runtime Launch and Verification v26（当前）](runtime-launch-and-verification-v26.md) | v25 的启动、权限与平台边界不变；仅 `trae-cn-cli` 额外允许实测 Bash `rawInput.Command` 进入公开 command，其他 ACP Adapter fail closed |
