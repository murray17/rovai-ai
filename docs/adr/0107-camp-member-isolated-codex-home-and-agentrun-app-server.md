...
- [v0.39 Codex 隔离实施合同](../versions/v0.39/codex-home-isolation.md)
...
- [ADR-0104: Rovai-Preferred MCP Projection and External Degradation](0104-rovai-preferred-mcp-projection-and-external-degradation.md)
