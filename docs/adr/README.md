...
| [ADR-0099](0099-cost-gated-independent-member-calls.md) | Cost-Gated Independent Member Calls Without Return Semantics | `accepted` | v0.34 | ← ADR-0091；移除 Return Policy、Return Obligation、Call Outcome 与自动回联语义 |
