...
| [ADR-0183](0183-scope-identified-agent-memory-revision-targets.md) | Scope-Identified Agent Memory Revision Targets | `accepted` | [v0.75](../versions/v0.75/README.md) | 冻结 Agent-relative Scope identity、revision target CAS/no-change 校验与 anti-oracle rejection |
| [ADR-0184](0184-durable-composer-reply-intent-and-explicit-recipient-resolution.md) | Durable Composer Reply Intent and Explicit Recipient Resolution | `accepted` | [v0.76](../versions/v0.76/README.md) | 局部替代 ADR-0128 的 caller-supplied user reply target，并扩展 ADR-0080 的 Draft 持久范围与显式换人边界 |
