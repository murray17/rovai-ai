...
| [ADR-0167](0167-seven-skill-official-inventory.md) | Seven-Skill Official Inventory | `accepted` | [v0.65](../versions/v0.65/README.md) | ← ADR-0159；冻结完整七项 official Skill、普通 `cli-operations` 投递与 pinned `tasteful-ui` 继承 |
