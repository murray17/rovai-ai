...
| [ADR-0174](0174-ten-skill-official-inventory-and-pinned-matt-pocock-imports.md) | Ten-Skill Official Inventory and Pinned Matt Pocock Imports | `accepted` | [v0.70](../versions/v0.70/README.md) | ← ADR-0167；冻结十项 official Skill 与三项 pinned `mattpocock/skills` 导入 |
