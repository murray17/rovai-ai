...
| [ADR-0091](0091-durable-member-calls-and-single-slot-a2a-resume.md) | Durable Member Calls and Single-Slot A2A Resume Scheduling | `accepted` | [v0.32](../versions/v0.32/README.md) | 局部替代 ADR-0014 的同步 A2A Run 与旧工具合同、ADR-0067 的 source/reply correlation；细化 ADR-0062/0077/0079 的 Turn Stop |
