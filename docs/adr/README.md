...
| [ADR-0145](0145-sole-native-session-self-identity-and-peer-routing-projection.md) | Sole Native-Session Self Identity and Peer Routing Projection | `accepted` | [v0.50](../versions/v0.50/README.md) | 细化 ADR-0100 的唯一 Self Identity，并局部替代 ADR-0129 的 Stable Collaboration State self/member、Lead 与 digest 条款 |
