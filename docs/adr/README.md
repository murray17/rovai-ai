...
| [ADR-0186](0186-durable-composer-recipient-continuation.md) | Durable Composer Recipient Continuation | `accepted` | [v0.78](../versions/v0.78/README.md) | 扩展 ADR-0080/ADR-0128 的 Draft 与 exact send，并复用 ADR-0185 的显式修复和无 Default Lead fallback |
