...
| [ADR-0193](0193-durable-gather-barrier-over-unified-message-delivery.md) | Durable Gather Barrier over Unified Message Delivery | `accepted` | [v0.89](../versions/v0.89/README.md) | 局部覆盖 ADR-0163 的 Gather return materialization；冻结统一 Delivery 上的 Capture、Barrier、Completion FIFO 与预算 |
| [ADR-0194](0194-mandatory-typed-gather-completion-current-input.md) | Mandatory Typed Gather Completion Current Input | `accepted` | [v0.89](../versions/v0.89/README.md) | 扩展 ADR-0067/0147 的 Current Input closed union；冻结 typed snapshot、Manifest evidence 与 exact recovery |
| [ADR-0195](0195-generation-scoped-last-gather-return.md) | Generation-Scoped Last Gather Return with Independent Bound | `accepted` | [v0.90](../versions/v0.90/README.md) | 局部覆盖 ADR-0193 的 capture budget、收窄 ADR-0194 的 result projection；冻结当前代最后结果和独立限额 |
| [ADR-0196](0196-self-contained-gather-completion-request.md) | Self-Contained Gather Request in Mandatory Completion Input | `accepted` | [v0.90](../versions/v0.90/README.md) | 扩展 ADR-0194 的 mandatory input；冻结完整请求正文/digest、v2 shape 与 v1 exact recovery |
| [ADR-0197](0197-empty-user-owned-mcp-library.md) | Empty User-Owned MCP Library Without Product Presets | `accepted` | [v0.91](../versions/v0.91/README.md) | 局部替代 ADR-0103 的 reviewed built-in definitions 与 preset provenance；其余 canonical schema/identity/Assignment 条款不变 |
| [ADR-0198](0198-bounded-open-round-grill-duo-skills.md) | Bounded Open-Round Protocol for Self-Contained Grill Duo Skills | `accepted` | [v0.92](../versions/v0.92/README.md) | 局部替代历史 Grill 一题一轮行为；冻结 1–4 题开放轮次、部分回答、当前搭档直接回复与自包含 Skill 边界 |
