...
| [ADR-0150](0150-evidence-first-agent-codebase-analysis-bundled-skill.md) | Evidence-First Agent Codebase Analysis Bundled Skill | `accepted` | [v0.52](../versions/v0.52/README.md) | ← ADR-0144；官方集合扩展为五个、移除名称的 `rovai-` 前缀，并冻结代码证据优先、默认只读的 Agent 仓库分析工作流 |
