...
- Current version architecture and implementation status: [`docs/versions/v0.05/README.md`](docs/versions/v0.05/README.md).
...
- For any UI/UX or renderer-facing change, read and follow [`docs/UI_STYLE.md`](docs/UI_STYLE.md).
