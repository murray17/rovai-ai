...
| [Pi Coding Agent](https://github.com/earendil-works/pi) *(experimental preview)* | Rovai projection unsupported; Pi-native extensions remain available | Added alongside Pi-native discovery | Exact-first native resume with replacement fallback |
