# `option-ext 0.2.0` Provenance and Review Status

| Field | Value |
|---|---|
| Crate | `option-ext 0.2.0` |
| License | MPL-2.0 |
| crates.io checksum | `04744f49eae99ab78e0d5c0b603ab218f515ea8cfe5a456d7629ad883a3b6e7d` |
...
`272f22fc9ea1ac6b08f01704af52c4ac338df4e2`, but the current public upstream
repository does not expose that object. Its visible release commit
`a582525c8584889c2a7dd1818c5d958e1e7f918c` is therefore not represented as
the exact archive revision. The checksummed crates.io archive is the fixed
source authority.
