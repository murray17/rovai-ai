...
description: Write and restructure documents consumed by coding agents, including Skills, AGENTS.md, CLAUDE.md, and documents reached through agent-facing pointers. Use for invocation wording, progressive disclosure, completion criteria, or pruning agent instructions; not for ordinary user documentation, product copy, or code comments.
---
