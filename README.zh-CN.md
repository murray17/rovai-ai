...
让他们围绕真正的任务追问、讨论、行动，并在一次次旅程中逐渐形成<br>
属于这支队伍的默契与协作记忆。
...
做着做着，它开始不说人话了。于是你把它的回答复制给另一个模型，
请它翻译一下 GPT 到底想表达什么。接着你又找来第三个模型，让它挑出
方案里的漏洞，并帮你判断这件事到底该不该做。

等你回过神来，你已经成了这群 Agent 之间最忙的传令兵、翻译和裁判。

问题不是模型不够强。

**问题是，你拥有的还不是一支队伍，而是一群彼此不认识的强大个体。**

一支真正的冒险团，不只需要一个能够提出方案的军师。它还需要敢于探索
未知的斥候、不肯放过模糊答案的追问者、把讨论变成成果的行动者，以及
记得团队为什么这样选择的记录者。

于是，我们让这些 Agent 组起团来。

在 Rovai AI 中，你是这支队伍的 **Principal**。你决定招募谁、要去哪里，
以及这支队伍最终会成为什么。

你可以从喜欢的游戏、电影、动画和故事中寻找角色原型，把那些吸引你的
性格、能力与伙伴关系，塑造成真正属于自己的长期队员。不是照搬一个现成
角色，而是组建一支你真正愿意与之共同历险的队伍。

他们会在一次次任务中产生分歧、互相追问、建立信任，并逐渐记住谁擅长
探索，谁善于决策，谁总能发现风险，以及这支队伍过去是怎样一起解决问题的。

**Rovai AI 不是让你多开几个 Agent，而是让你组建一支会协作、会磨合、
也会一起成长的队伍。**
