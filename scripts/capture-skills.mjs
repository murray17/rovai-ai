...
try {
  ...
  await waitForExpression(cdp, `Boolean(document.querySelector('.appearance-settings-page'))`, 5_000)
  const appearanceReady = await evaluate(cdp, `Boolean(document.querySelector('.appearance-settings-page'))`)
