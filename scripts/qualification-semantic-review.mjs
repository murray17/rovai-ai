...
if (['generic-task-v7', 'generic-task-v8'].includes(caseEvaluation?.judgeProfile)) {
...
const sourceConfiguration = buildSemanticJudgeConfiguration({
  evaluationContextPolicy: caseEvaluation?.judgeProfile === 'generic-task-v8' ? 'bounded-evaluation-context-v3' : caseEvaluation?.judgeProfile === 'generic-task-v7' ? 'bounded-evaluation-context-v2' : ['generic-task-v4', 'generic-task-v5', 'generic-task-v6'].includes(caseEvaluation?.judgeProfile) ? 'bounded-evaluation-context-v1' : null,
