...
test('current contract profile is deterministic, offline, and covers every requested criterion', async () => {
  ...
  assert.equal(CURRENT_CONTRACT_PROFILE.version, '1.26.0')
  assert.equal(CURRENT_CONTRACT_PROFILE.suite.version, '1.26.0')
  assert.deepEqual(CURRENT_CONTRACT_DATA_STORE, { version: 'v1.26', projectionSchemaVersion: 67 })
