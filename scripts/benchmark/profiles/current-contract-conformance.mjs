...
const criteria = [
  ...
  criterion('CCC-011', 'Data Contract is v0.78 with projection schema 39', [
  ...
  criterion('CCC-013', 'The migration chain admits only exact v0.77/v0.73/v0.71/v0.67/v0.66/v0.62/v0.54/v0.52 upgrade sources', [
    test('crates/rovai-core/src/db.rs', 'current_data_contract_accepts_current_and_exact_upgrade_sources')
  ]),
